---
broker: "DB증권"
source_url: "https://openapi.db-fi.com/apiservice?group_id=05ac28b8-624f-4115-8aed-cf55f24279dd&api_id=e9b883fe-6978-476a-b3a4-faba34107006"
scraped_at: "2026-05-22T15:19:33.392Z"
category: "국내주식주문"
api_id: "e9b883fe-6978-476a-b3a4-faba34107006"
api_name: "주식정정주문- NXT거래소"
tr_id: "2e3c003b-4d1d-47d7-a1be-9d0ecc85759b"
tr_code: "CSPAT00710"
method: "POST"
...
| --- | --- |
| 그룹 | 국내주식주문 |
| API 페이지 | 주식정정주문- NXT거래소 |
| TR명 | 주식정정주문-NXT |
| TR코드 | `CSPAT00710` |
| 초당 전송 건수 | 3 |
| 설명 | NXT 주문에 대해 정정하는 API 입니다.<br><br>※ 이미 체결완료된 주문은 정정이 불가능합니다. |
...
| Request Body | `-IsuNo` | 종목번호 | String | N | 12 | 원주문시 사용한 종목번호 |
...
| Request Body | `-OrdPrc` | 주문가 | Number | Y | 13 | 정정주문 1주당 주문가격 |
...
| Response Body | `-OrdNo` | 주문번호 | Number | Y | 10 | 정정주문으로 채번된 주문번호 |
...
| Response Body | `-OrdAmt` | 주문금액 | Number | Y | 16 | 정정주문시 사용된 금액<br>시장가 주문시 "0" 으로 표시 |
