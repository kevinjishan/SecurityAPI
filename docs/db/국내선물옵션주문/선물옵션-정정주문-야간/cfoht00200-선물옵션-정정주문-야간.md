---
broker: "DB증권"
source_url: "https://openapi.db-fi.com/apiservice?group_id=44c4a04f-f55e-4c1c-b4e2-b48ec4869aee&api_id=a18296b3-5290-4083-8f09-67dbd85b6f53"
scraped_at: "2026-05-22T15:19:33.392Z"
category: "국내선물옵션주문"
api_id: "a18296b3-5290-4083-8f09-67dbd85b6f53"
api_name: "선물옵션 정정주문 (야간)"
tr_id: "e33f4c0e-b28e-4ca3-8878-086dfd35029f"
tr_code: "CFOHT00200"
method: "POST"
domain: "https://openapi.dbsec.co.kr:8443"
path: "/api/v1/trading/night-futureoption/order-revision"
...
| --- | --- |
| 그룹 | 국내선물옵션주문 |
| API 페이지 | 선물옵션 정정주문 (야간) |
| TR명 | 선물옵션 정정주문 (야간) |
| TR코드 | `CFOHT00200` |
| 초당 전송 건수 | 10 |
| 설명 | 야간선물옵션 주문에 대해 정정하는 API 입니다.<br><br>※ 이미 체결완료된 주문은 정정이 불가능합니다. |
...
```json
{
  "Out": {
    ...
    "AcntNm": "길주월",
    "IsuNm": "F 202403",
    "OrdAbleAmt": 1088191092,
    "MnyOrdAbleAmt": 1109847800,
    "OrdMgn": 193622875,
    "MnyOrdMgn": 171748937,
    "OrdAbleQty": 0
  },
