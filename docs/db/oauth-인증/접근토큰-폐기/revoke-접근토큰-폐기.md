---
broker: "DB증권"
source_url: "https://openapi.db-fi.com/apiservice?group_id=cc55b867-e049-421b-a798-be016370ff44&api_id=3395b34c-f48c-436f-a5fa-dbae6b224af8"
scraped_at: "2026-05-22T15:19:33.392Z"
category: "OAuth 인증"
api_id: "3395b34c-f48c-436f-a5fa-dbae6b224af8"
api_name: "접근토큰 폐기"
tr_id: "59e897e8-a609-4305-b41d-6e3906ffca08"
tr_code: "revoke"
method: "POST"
...
| Request Body | `token_type_hint` | 토큰 유형 hint | String | Y | 100 | access_token, refresh_token 토큰 타입 |
| Request Body | `token` | 접근토큰 | String | Y | 1000 | - |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Response Body | `code` | 응답코드 | String | Y | 8 | - |
| Response Body | `msg` | 응답메세지 | String | Y | 450 | - |
