---
broker: "DB증권"
source_url: "https://openapi.db-fi.com/apiservice?group_id=548b70a6-24cc-4d9d-a7c7-90eb84a497f4&api_id=1174e749-16cf-4aaa-bdd2-b881d7072b6e"
scraped_at: "2026-05-22T15:19:33.392Z"
category: "국내선물옵션시세(실시간)"
api_id: "1174e749-16cf-4aaa-bdd2-b881d7072b6e"
api_name: "[실시간]미니옵션호가(야간)"
tr_id: "669aa5ef-95df-4cdf-8e3f-100737619f34"
tr_code: "E11"
method: "POST"
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Request Body | `tr_cd` | 거래코드 | String | Y | 3 | TR코드입력: E11 |
| Request Body | `tr_key` | 종목코드 | String | Y | 20 | 미니옵션(야간): EM<br>※ 종목분류코드 + 미니옵션(야간) 종목코드 입력 (ex. EM206V5007) |
...
| Response Body | `Askp4` | 색참조(+상승, -하락) | String | Y | 1 | - |
