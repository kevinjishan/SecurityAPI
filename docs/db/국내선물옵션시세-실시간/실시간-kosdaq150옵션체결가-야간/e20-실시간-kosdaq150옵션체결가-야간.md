---
broker: "DB증권"
source_url: "https://openapi.db-fi.com/apiservice?group_id=548b70a6-24cc-4d9d-a7c7-90eb84a497f4&api_id=4d593338-5bdb-41f1-8b68-dfef0fd3cea6"
scraped_at: "2026-05-22T15:19:33.392Z"
category: "국내선물옵션시세(실시간)"
api_id: "4d593338-5bdb-41f1-8b68-dfef0fd3cea6"
api_name: "[실시간]KOSDAQ150옵션체결가(야간)"
tr_id: "83cd4388-ca4b-40b4-a9c9-c5fa002a21f2"
tr_code: "E20"
method: "POST"
...
| --- | --- |
| 그룹 | 국내선물옵션시세(실시간) |
| API 페이지 | [실시간]KOSDAQ150옵션체결가(야간) |
| TR명 | [실시간]KOSDAQ150옵션체결가(야간) |
| TR코드 | `E20` |
| 초당 전송 건수 | - |
| 설명 | KOSDAQ150옵션체결가(야간) API입니다. |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Request Body | `tr_cd` | 거래코드 | String | Y | 3 | TR코드입력: E20 |
| Request Body | `tr_key` | 종목코드 | String | Y | 20 | KOSDAQ150옵션(야간): EQ<br>※ 종목분류코드 + 지수옵션종목코드 입력 (ex. EQ201V5360) |
