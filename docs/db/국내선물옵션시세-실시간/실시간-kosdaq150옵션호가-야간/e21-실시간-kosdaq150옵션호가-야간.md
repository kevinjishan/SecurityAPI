---
broker: "DB증권"
source_url: "https://openapi.db-fi.com/apiservice?group_id=548b70a6-24cc-4d9d-a7c7-90eb84a497f4&api_id=94a4a8ab-102e-4fd7-acd8-9032c1eab191"
scraped_at: "2026-05-22T15:19:33.392Z"
category: "국내선물옵션시세(실시간)"
api_id: "94a4a8ab-102e-4fd7-acd8-9032c1eab191"
api_name: "[실시간]KOSDAQ150옵션호가(야간)"
tr_id: "2e1c1746-50fd-4e1a-8c2f-96bf26e9586d"
tr_code: "E21"
method: "POST"
...
| --- | --- |
| 그룹 | 국내선물옵션시세(실시간) |
| API 페이지 | [실시간]KOSDAQ150옵션호가(야간) |
| TR명 | [실시간]KOSDAQ150옵션호가(야간) |
| TR코드 | `E21` |
| 초당 전송 건수 | - |
| 설명 | KOSDAQ150옵션호가(야간) API입니다. |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Request Body | `tr_cd` | 거래코드 | String | Y | 3 | TR코드입력: EQ |
| Request Body | `tr_key` | 종목코드 | String | Y | 20 | KOSDAQ150옵션: EQ<br>※ 종목분류코드 + KOSDAQ150옵션 종목코드 입력 (ex. EQ206V5007) |
