...
| Body | `- type` | 실시간 항목 | String | Y | 2 | 0E | TR 명(0A,0B....) |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 샘플 | 설명 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Body | `- - 131` | 시간외매도호가총잔량 | String | N | - | - | - |
| Body | `- - 132` | 시간외매도호가총잔량직전대비 | String | N | - | - | - |
| Body | `- - 135` | 시간외매수호가총잔량 | String | N | - | - | - |
| Body | `- - 136` | 시간외매수호가총잔량직전대비 | String | N | - | - | - |
| Body | `- - 21` | 호가시간 | String | N | - | - | - |
| Body | `- item` | 실시간 등록 요소 | String | N | - | - | 거래소별 종목코드<br>(KRX:039490,NXT:039490_NX,SOR:039490_AL) |
