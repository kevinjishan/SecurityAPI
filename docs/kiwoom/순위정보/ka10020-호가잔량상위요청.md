...
| Body | `sort_tp` | 정렬구분 | String | Y | 1 | 1 | 1:순매수잔량순, 2:순매도잔량순, 3:매수비율순, 4:매도비율순 |
...
| Body | `trde_qty_tp` | 거래량구분 | String | Y | 4 | 0000 | 0000:장시작전(0주이상), 0010:만주이상, 0050:5만주이상, 00100:10만주이상 |
