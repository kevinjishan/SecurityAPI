...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 샘플 | 설명 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Body | `mrkt_tp` | 시장구분 | String | Y | 3 | 101 | 000:전체, 001:코스피, 101:코스닥 |
| Body | `qry_tp` | 조회구분 | String | Y | 1 | 1 | 1:전일거래량 상위100종목, 2:전일거래대금 상위100종목 |
| Body | `rank_end` | 순위끝 | String | Y | 3 | 10 | 0 ~ 100 값 중에  조회를 원하는 순위 끝값 |
| Body | `rank_strt` | 순위시작 | String | Y | 3 | 0 | 0 ~ 100 값 중에  조회를 원하는 순위 시작값 |
