...
| Body | `rt_tp` | 비율구분 | String | Y | 1 | 1 | 1:매수/매도비율, 2:매도/매수비율 |
...
| Body | `tm_tp` | 시간구분 | String | Y | 2 | 1 | 분 입력 |
| Body | `trde_qty_tp` | 거래량구분 | String | Y | 1 | 5 | 5:5천주이상, 10:만주이상, 50:5만주이상, 100:10만주이상 |
