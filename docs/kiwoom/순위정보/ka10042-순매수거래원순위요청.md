...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 샘플 | 설명 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Body | `dt` | 기간 | String | N | 4 | 5 | 5:5일, 10:10일, 20:20일, 40:40일, 60:60일, 120:120일 |
...
| Body | `strt_dt` | 시작일자 | String | N | 8 | 20241031 | YYYYMMDD<br>(연도4자리, 월 2자리, 일 2자리 형식) |
