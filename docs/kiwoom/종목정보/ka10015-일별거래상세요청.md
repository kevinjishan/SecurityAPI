...
| Body | `strt_dt` | 시작일자 | String | Y | 8 | 20241105 | YYYYMMDD |
...
| Body | `- af_mkrt_trde_prica_wght` | 장후거래대금비중 | String | N | 20 | - | - |
...
| Body | `- bf_mkrt_trde_prica_wght` | 장전거래대금비중 | String | N | 20 | - | - |
...
| Body | `- opmr_trde_prica_wght` | 장중거래대금비중 | String | N | 20 | - | - |
