...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 샘플 | 설명 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Body | `appkey` | 앱키 | String | Y | - | AxserEsdcredca..... | - |
| Body | `grant_type` | grant_type | String | Y | - | client_credentials | client_credentials 입력 |
| Body | `secretkey` | 시크릿키 | String | Y | - | SEefdcwcforehDre2fdvc.... | - |
