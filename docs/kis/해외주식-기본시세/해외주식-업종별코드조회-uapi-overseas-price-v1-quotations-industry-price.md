...
category: "[해외주식] 기본시세"
api_id: "/uapi/overseas-price/v1/quotations/industry-price"
api_name: "해외주식 업종별코드조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 기본시세 |
| API path | `/uapi/overseas-price/v1/quotations/industry-price` |
| 샘플 TR ID | HHDFS76370100 |
| 공식 샘플 파일 | examples_llm/overseas_stock/industry_price/industry_price.py |
