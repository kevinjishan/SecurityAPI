...
category: "[해외주식] 기본시세"
api_id: "/uapi/overseas-price/v1/quotations/dailyprice"
api_name: "해외주식 기간별시세"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 기본시세 |
| API path | `/uapi/overseas-price/v1/quotations/dailyprice` |
| 샘플 TR ID | HHDFS76240000 |
| 공식 샘플 파일 | examples_llm/overseas_stock/dailyprice/dailyprice.py |
