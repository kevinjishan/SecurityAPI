...
category: "[해외주식] 기본시세"
api_id: "/uapi/overseas-price/v1/quotations/inquire-daily-chartprice"
api_name: "해외주식 종목/지수/환율기간별시세(일/주/월/년)"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 기본시세 |
| API path | `/uapi/overseas-price/v1/quotations/inquire-daily-chartprice` |
| 샘플 TR ID | FHKST03030100 |
| 공식 샘플 파일 | examples_llm/overseas_stock/inquire_daily_chartprice/inquire_daily_chartprice.py |
