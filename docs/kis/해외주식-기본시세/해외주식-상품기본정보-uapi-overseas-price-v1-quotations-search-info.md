...
category: "[해외주식] 기본시세"
api_id: "/uapi/overseas-price/v1/quotations/search-info"
api_name: "해외주식 상품기본정보"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 기본시세 |
| API path | `/uapi/overseas-price/v1/quotations/search-info` |
| 샘플 TR ID | CTPF1702R |
| 공식 샘플 파일 | examples_llm/overseas_stock/search_info/search_info.py |
