...
category: "[해외주식] 기본시세"
api_id: "/uapi/overseas-price/v1/quotations/inquire-ccnl"
api_name: "해외주식 체결추이"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 기본시세 |
| API path | `/uapi/overseas-price/v1/quotations/inquire-ccnl` |
| 샘플 TR ID | HHDFS76200300 |
| 공식 샘플 파일 | examples_llm/overseas_stock/quot_inquire_ccnl/quot_inquire_ccnl.py |
