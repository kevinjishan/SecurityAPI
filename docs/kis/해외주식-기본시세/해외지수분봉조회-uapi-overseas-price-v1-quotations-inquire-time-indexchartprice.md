...
category: "[해외주식] 기본시세"
api_id: "/uapi/overseas-price/v1/quotations/inquire-time-indexchartprice"
api_name: "해외지수분봉조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 기본시세 |
| API path | `/uapi/overseas-price/v1/quotations/inquire-time-indexchartprice` |
| 샘플 TR ID | FHKST03030200 |
| 공식 샘플 파일 | examples_llm/overseas_stock/inquire_time_indexchartprice/inquire_time_indexchartprice.py |
