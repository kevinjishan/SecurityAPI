...
category: "[해외주식] 기본시세"
api_id: "/uapi/overseas-price/v1/quotations/price"
api_name: "해외주식 현재체결가"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 기본시세 |
| API path | `/uapi/overseas-price/v1/quotations/price` |
| 샘플 TR ID | HHDFS00000300 |
| 공식 샘플 파일 | examples_llm/overseas_stock/price/price.py |
