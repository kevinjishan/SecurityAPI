...
category: "[해외주식] 기본시세"
api_id: "/uapi/overseas-price/v1/quotations/inquire-asking-price"
api_name: "해외주식 현재가 호가"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 기본시세 |
| API path | `/uapi/overseas-price/v1/quotations/inquire-asking-price` |
| 샘플 TR ID | HHDFS76200100 |
| 공식 샘플 파일 | examples_llm/overseas_stock/inquire_asking_price/inquire_asking_price.py |
