...
category: "[해외주식] 기본시세"
api_id: "/uapi/overseas-stock/v1/quotations/countries-holiday"
api_name: "해외결제일자조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 기본시세 |
| API path | `/uapi/overseas-stock/v1/quotations/countries-holiday` |
| 샘플 TR ID | CTOS5011R |
| 공식 샘플 파일 | examples_llm/overseas_stock/countries_holiday/countries_holiday.py |
...
| 위치 | 필드 | 필수 |
| --- | --- | --- |
| Query/Body | `TRAD_DT` | Y |
| Query/Body | `CTX_AREA_NK` | Y |
| Query/Body | `CTX_AREA_FK` | Y |
