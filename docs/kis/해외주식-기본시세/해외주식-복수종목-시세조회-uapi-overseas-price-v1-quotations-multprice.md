...
category: "[해외주식] 기본시세"
api_id: "/uapi/overseas-price/v1/quotations/multprice"
api_name: "해외주식 복수종목 시세조회"
method: "GET"
...
# 해외주식 복수종목 시세조회 (/uapi/overseas-price/v1/quotations/multprice)
...
| --- | --- |
| 카테고리 | [해외주식] 기본시세 |
| API path | `/uapi/overseas-price/v1/quotations/multprice` |
| 샘플 TR ID | - |
| 공식 샘플 파일 | - |
