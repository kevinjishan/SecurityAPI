...
category: "[장내채권] 주문/계좌"
api_id: "/uapi/domestic-bond/v1/trading/inquire-balance"
api_name: "장내채권 잔고조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [장내채권] 주문/계좌 |
| API path | `/uapi/domestic-bond/v1/trading/inquire-balance` |
| 샘플 TR ID | CTSC8407R |
| 공식 샘플 파일 | examples_llm/domestic_bond/inquire_balance/inquire_balance.py |
