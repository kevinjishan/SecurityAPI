...
category: "[장내채권] 주문/계좌"
api_id: "/uapi/domestic-bond/v1/trading/inquire-psbl-rvsecncl"
api_name: "채권정정취소가능주문조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [장내채권] 주문/계좌 |
| API path | `/uapi/domestic-bond/v1/trading/inquire-psbl-rvsecncl` |
| 샘플 TR ID | CTSC8035R |
| 공식 샘플 파일 | examples_llm/domestic_bond/inquire_psbl_rvsecncl/inquire_psbl_rvsecncl.py |
