...
category: "[장내채권] 주문/계좌"
api_id: "/uapi/domestic-bond/v1/trading/inquire-psbl-order"
api_name: "장내채권 매수가능조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [장내채권] 주문/계좌 |
| API path | `/uapi/domestic-bond/v1/trading/inquire-psbl-order` |
| 샘플 TR ID | TTTC8910R |
| 공식 샘플 파일 | examples_llm/domestic_bond/inquire_psbl_order/inquire_psbl_order.py |
