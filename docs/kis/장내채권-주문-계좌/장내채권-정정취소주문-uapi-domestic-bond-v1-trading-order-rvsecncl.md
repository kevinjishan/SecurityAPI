...
category: "[장내채권] 주문/계좌"
api_id: "/uapi/domestic-bond/v1/trading/order-rvsecncl"
api_name: "장내채권 정정취소주문"
method: "POST"
...
| --- | --- |
| 카테고리 | [장내채권] 주문/계좌 |
| API path | `/uapi/domestic-bond/v1/trading/order-rvsecncl` |
| 샘플 TR ID | TTTC0953U |
| 공식 샘플 파일 | examples_llm/domestic_bond/order_rvsecncl/order_rvsecncl.py |
