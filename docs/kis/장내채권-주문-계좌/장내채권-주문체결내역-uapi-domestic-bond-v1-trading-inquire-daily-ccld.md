...
category: "[장내채권] 주문/계좌"
api_id: "/uapi/domestic-bond/v1/trading/inquire-daily-ccld"
api_name: "장내채권 주문체결내역"
method: "GET"
...
| --- | --- |
| 카테고리 | [장내채권] 주문/계좌 |
| API path | `/uapi/domestic-bond/v1/trading/inquire-daily-ccld` |
| 샘플 TR ID | CTSC8013R |
| 공식 샘플 파일 | examples_llm/domestic_bond/inquire_daily_ccld/inquire_daily_ccld.py |
...
| Query/Body | `SORT_SQN_DVSN` | Y |
| Query/Body | `PDNO` | Y |
| Query/Body | `NCCS_YN` | Y |
