...
api_id: "/uapi/overseas-futureoption/v1/trading/inquire-ccld"
api_name: "해외선물옵션 당일주문내역조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외선물옵션] 주문/계좌 |
| API path | `/uapi/overseas-futureoption/v1/trading/inquire-ccld` |
| 샘플 TR ID | OTFM3116R |
| 공식 샘플 파일 | examples_llm/overseas_futureoption/inquire_ccld/inquire_ccld.py |
