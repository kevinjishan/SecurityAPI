...
api_id: "/uapi/overseas-futureoption/v1/trading/inquire-daily-ccld"
api_name: "해외선물옵션 일별 체결내역"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외선물옵션] 주문/계좌 |
| API path | `/uapi/overseas-futureoption/v1/trading/inquire-daily-ccld` |
| 샘플 TR ID | OTFM3122R |
| 공식 샘플 파일 | examples_llm/overseas_futureoption/inquire_daily_ccld/inquire_daily_ccld.py |
