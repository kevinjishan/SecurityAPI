...
api_id: "/uapi/overseas-futureoption/v1/trading/inquire-unpd"
api_name: "해외선물옵션 미결제내역조회(잔고)"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외선물옵션] 주문/계좌 |
| API path | `/uapi/overseas-futureoption/v1/trading/inquire-unpd` |
| 샘플 TR ID | OTFM1412R |
| 공식 샘플 파일 | examples_llm/overseas_futureoption/inquire_unpd/inquire_unpd.py |
