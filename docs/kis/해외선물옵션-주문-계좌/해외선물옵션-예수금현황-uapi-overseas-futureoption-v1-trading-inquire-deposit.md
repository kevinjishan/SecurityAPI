...
api_id: "/uapi/overseas-futureoption/v1/trading/inquire-deposit"
api_name: "해외선물옵션 예수금현황"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외선물옵션] 주문/계좌 |
| API path | `/uapi/overseas-futureoption/v1/trading/inquire-deposit` |
| 샘플 TR ID | OTFM1411R |
| 공식 샘플 파일 | examples_llm/overseas_futureoption/inquire_deposit/inquire_deposit.py |
