...
api_id: "/uapi/overseas-futureoption/v1/trading/margin-detail"
api_name: "해외선물옵션 증거금상세"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외선물옵션] 주문/계좌 |
| API path | `/uapi/overseas-futureoption/v1/trading/margin-detail` |
| 샘플 TR ID | OTFM3115R |
| 공식 샘플 파일 | examples_llm/overseas_futureoption/margin_detail/margin_detail.py |
