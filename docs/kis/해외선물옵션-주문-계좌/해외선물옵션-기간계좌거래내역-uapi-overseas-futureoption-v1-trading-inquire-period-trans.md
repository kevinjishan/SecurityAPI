...
api_id: "/uapi/overseas-futureoption/v1/trading/inquire-period-trans"
api_name: "해외선물옵션 기간계좌거래내역"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외선물옵션] 주문/계좌 |
| API path | `/uapi/overseas-futureoption/v1/trading/inquire-period-trans` |
| 샘플 TR ID | OTFM3114R |
| 공식 샘플 파일 | examples_llm/overseas_futureoption/inquire_period_trans/inquire_period_trans.py |
...
| Query/Body | `JPY` | Y |
| Query/Body | `VND` | Y |
| Query/Body | `INQR_TERM_FROM_DT` | Y |
| Query/Body | `INQR_TERM_TO_DT` | Y |
| Query/Body | `CANO` | Y |
| Query/Body | `ACNT_PRDT_CD` | Y |
| Query/Body | `ACNT_TR_TYPE_CD` | Y |
| Query/Body | `CRCY_CD` | Y |
| Query/Body | `CTX_AREA_FK100` | Y |
| Query/Body | `CTX_AREA_NK100` | Y |
| Query/Body | `PWD_CHK_YN` | Y |
