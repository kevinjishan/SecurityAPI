...
api_id: "/uapi/overseas-futureoption/v1/trading/inquire-psamount"
api_name: "해외선물옵션 주문가능조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외선물옵션] 주문/계좌 |
| API path | `/uapi/overseas-futureoption/v1/trading/inquire-psamount` |
| 샘플 TR ID | OTFM3304R |
| 공식 샘플 파일 | examples_llm/overseas_futureoption/inquire_psamount/inquire_psamount.py |
