...
category: "[국내주식] 업종/기타"
api_id: "/uapi/domestic-stock/v1/quotations/market-time"
api_name: "국내선물 영업일조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 업종/기타 |
| API path | `/uapi/domestic-stock/v1/quotations/market-time` |
| 샘플 TR ID | HHMCM000002C0 |
| 공식 샘플 파일 | examples_llm/domestic_stock/market_time/market_time.py |
