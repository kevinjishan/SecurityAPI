...
category: "[국내주식] 업종/기타"
api_id: "/uapi/domestic-stock/v1/quotations/inquire-index-category-price"
api_name: "국내업종 구분별전체시세"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 업종/기타 |
| API path | `/uapi/domestic-stock/v1/quotations/inquire-index-category-price` |
| 샘플 TR ID | FHPUP02140000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/inquire_index_category_price/inquire_index_category_price.py |
