...
category: "[국내주식] 업종/기타"
api_id: "/uapi/domestic-stock/v1/quotations/exp-total-index"
api_name: "국내주식 예상체결 전체지수"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 업종/기타 |
| API path | `/uapi/domestic-stock/v1/quotations/exp-total-index` |
| 샘플 TR ID | FHKUP11750000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/exp_total_index/exp_total_index.py |
