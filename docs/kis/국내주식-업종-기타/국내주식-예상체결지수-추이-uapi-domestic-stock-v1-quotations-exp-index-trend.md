...
category: "[국내주식] 업종/기타"
api_id: "/uapi/domestic-stock/v1/quotations/exp-index-trend"
api_name: "국내주식 예상체결지수 추이"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 업종/기타 |
| API path | `/uapi/domestic-stock/v1/quotations/exp-index-trend` |
| 샘플 TR ID | FHPST01840000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/exp_index_trend/exp_index_trend.py |
...
| 위치 | 필드 | 필수 |
| --- | --- | --- |
| Query/Body | `FID_MKOP_CLS_CODE` | Y |
