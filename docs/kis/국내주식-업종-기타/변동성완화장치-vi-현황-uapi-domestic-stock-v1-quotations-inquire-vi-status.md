...
category: "[국내주식] 업종/기타"
api_id: "/uapi/domestic-stock/v1/quotations/inquire-vi-status"
api_name: "변동성완화장치(VI) 현황"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 업종/기타 |
| API path | `/uapi/domestic-stock/v1/quotations/inquire-vi-status` |
| 샘플 TR ID | FHPST01390000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/inquire_vi_status/inquire_vi_status.py |
