...
category: "[국내주식] 업종/기타"
api_id: "/uapi/domestic-stock/v1/quotations/inquire-index-price"
api_name: "국내업종 현재지수"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 업종/기타 |
| API path | `/uapi/domestic-stock/v1/quotations/inquire-index-price` |
| 샘플 TR ID | FHPUP02100000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/inquire_index_price/inquire_index_price.py |
