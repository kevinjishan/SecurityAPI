...
category: "[국내주식] 업종/기타"
api_id: "/uapi/domestic-stock/v1/quotations/inquire-daily-indexchartprice"
api_name: "국내주식업종기간별시세(일/주/월/년)"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 업종/기타 |
| API path | `/uapi/domestic-stock/v1/quotations/inquire-daily-indexchartprice` |
| 샘플 TR ID | FHKUP03500100 |
| 공식 샘플 파일 | examples_llm/domestic_stock/inquire_daily_indexchartprice/inquire_daily_indexchartprice.py |
