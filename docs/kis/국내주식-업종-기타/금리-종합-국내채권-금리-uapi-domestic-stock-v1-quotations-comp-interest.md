...
category: "[국내주식] 업종/기타"
api_id: "/uapi/domestic-stock/v1/quotations/comp-interest"
api_name: "금리 종합(국내채권/금리)"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 업종/기타 |
| API path | `/uapi/domestic-stock/v1/quotations/comp-interest` |
| 샘플 TR ID | FHPST07020000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/comp_interest/comp_interest.py |
...
| Query/Body | `FID_DIV_CLS_CODE1` | Y |
