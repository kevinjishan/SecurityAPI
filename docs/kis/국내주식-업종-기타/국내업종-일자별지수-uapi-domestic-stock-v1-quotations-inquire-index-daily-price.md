...
category: "[국내주식] 업종/기타"
api_id: "/uapi/domestic-stock/v1/quotations/inquire-index-daily-price"
api_name: "국내업종 일자별지수"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 업종/기타 |
| API path | `/uapi/domestic-stock/v1/quotations/inquire-index-daily-price` |
| 샘플 TR ID | FHPUP02120000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/inquire_index_daily_price/inquire_index_daily_price.py |
