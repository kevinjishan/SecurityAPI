...
category: "[국내주식] 업종/기타"
api_id: "/uapi/domestic-stock/v1/quotations/inquire-index-tickprice"
api_name: "국내업종 시간별지수(초)"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 업종/기타 |
| API path | `/uapi/domestic-stock/v1/quotations/inquire-index-tickprice` |
| 샘플 TR ID | FHPUP02110100 |
| 공식 샘플 파일 | examples_llm/domestic_stock/inquire_index_tickprice/inquire_index_tickprice.py |
