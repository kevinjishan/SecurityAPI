...
api_id: "/uapi/overseas-futureoption/v1/quotations/inquire-asking-price"
api_name: "해외선물 호가"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외선물옵션] 기본시세 |
| API path | `/uapi/overseas-futureoption/v1/quotations/inquire-asking-price` |
| 샘플 TR ID | HHDFC86000000 |
| 공식 샘플 파일 | examples_llm/overseas_futureoption/inquire_asking_price/inquire_asking_price.py |
