...
api_id: "/uapi/overseas-futureoption/v1/quotations/inquire-price"
api_name: "해외선물종목현재가"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외선물옵션] 기본시세 |
| API path | `/uapi/overseas-futureoption/v1/quotations/inquire-price` |
| 샘플 TR ID | HHDFC55010000 |
| 공식 샘플 파일 | examples_llm/overseas_futureoption/inquire_price/inquire_price.py |
