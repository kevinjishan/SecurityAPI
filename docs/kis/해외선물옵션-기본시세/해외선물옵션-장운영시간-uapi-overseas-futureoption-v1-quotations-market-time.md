...
api_id: "/uapi/overseas-futureoption/v1/quotations/market-time"
api_name: "해외선물옵션 장운영시간"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외선물옵션] 기본시세 |
| API path | `/uapi/overseas-futureoption/v1/quotations/market-time` |
| 샘플 TR ID | OTFM2229R |
| 공식 샘플 파일 | examples_llm/overseas_futureoption/market_time/market_time.py |
...
| Query/Body | `FM_CLAS_CD` | Y |
| Query/Body | `FM_EXCG_CD` | Y |
| Query/Body | `OPT_YN` | Y |
