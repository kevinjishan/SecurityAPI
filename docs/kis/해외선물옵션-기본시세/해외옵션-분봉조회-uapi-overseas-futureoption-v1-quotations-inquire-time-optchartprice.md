...
api_id: "/uapi/overseas-futureoption/v1/quotations/inquire-time-optchartprice"
api_name: "해외옵션 분봉조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외선물옵션] 기본시세 |
| API path | `/uapi/overseas-futureoption/v1/quotations/inquire-time-optchartprice` |
| 샘플 TR ID | HHDFO55020100 |
| 공식 샘플 파일 | examples_llm/overseas_futureoption/inquire_time_optchartprice/inquire_time_optchartprice.py |
