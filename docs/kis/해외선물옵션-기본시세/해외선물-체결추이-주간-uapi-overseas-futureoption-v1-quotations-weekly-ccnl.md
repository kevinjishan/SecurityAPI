...
api_id: "/uapi/overseas-futureoption/v1/quotations/weekly-ccnl"
api_name: "해외선물 체결추이(주간)"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외선물옵션] 기본시세 |
| API path | `/uapi/overseas-futureoption/v1/quotations/weekly-ccnl` |
| 샘플 TR ID | HHDFC55020000 |
| 공식 샘플 파일 | examples_llm/overseas_futureoption/weekly_ccnl/weekly_ccnl.py |
