...
api_id: "/uapi/overseas-futureoption/v1/quotations/tick-ccnl"
api_name: "해외선물 체결추이(틱)"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외선물옵션] 기본시세 |
| API path | `/uapi/overseas-futureoption/v1/quotations/tick-ccnl` |
| 샘플 TR ID | HHDFC55020200 |
| 공식 샘플 파일 | examples_llm/overseas_futureoption/tick_ccnl/tick_ccnl.py |
