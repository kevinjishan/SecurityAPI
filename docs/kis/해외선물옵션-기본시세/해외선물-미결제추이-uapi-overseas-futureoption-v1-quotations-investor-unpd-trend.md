...
api_id: "/uapi/overseas-futureoption/v1/quotations/investor-unpd-trend"
api_name: "해외선물 미결제추이"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외선물옵션] 기본시세 |
| API path | `/uapi/overseas-futureoption/v1/quotations/investor-unpd-trend` |
| 샘플 TR ID | HHDDB95030000 |
| 공식 샘플 파일 | examples_llm/overseas_futureoption/investor_unpd_trend/investor_unpd_trend.py |
...
| 위치 | 필드 | 필수 |
| --- | --- | --- |
| Query/Body | `PROD_ISCD` | Y |
| Query/Body | `BSOP_DATE` | Y |
| Query/Body | `UPMU_GUBUN` | Y |
| Query/Body | `CTS_KEY` | Y |
