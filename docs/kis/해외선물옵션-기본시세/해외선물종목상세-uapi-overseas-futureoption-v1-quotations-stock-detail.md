...
api_id: "/uapi/overseas-futureoption/v1/quotations/stock-detail"
api_name: "해외선물종목상세"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외선물옵션] 기본시세 |
| API path | `/uapi/overseas-futureoption/v1/quotations/stock-detail` |
| 샘플 TR ID | HHDFC55010100 |
| 공식 샘플 파일 | examples_llm/overseas_futureoption/stock_detail/stock_detail.py |
