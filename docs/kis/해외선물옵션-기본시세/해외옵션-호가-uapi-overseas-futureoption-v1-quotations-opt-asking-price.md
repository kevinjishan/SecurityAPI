...
api_id: "/uapi/overseas-futureoption/v1/quotations/opt-asking-price"
api_name: "해외옵션 호가"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외선물옵션] 기본시세 |
| API path | `/uapi/overseas-futureoption/v1/quotations/opt-asking-price` |
| 샘플 TR ID | HHDFO86000000 |
| 공식 샘플 파일 | examples_llm/overseas_futureoption/opt_asking_price/opt_asking_price.py |
