...
category: "[국내주식] 기본시세"
api_id: "/uapi/domestic-stock/v1/quotations/inquire-member"
api_name: "주식현재가 회원사"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 기본시세 |
| API path | `/uapi/domestic-stock/v1/quotations/inquire-member` |
| 샘플 TR ID | FHKST01010600 |
| 공식 샘플 파일 | examples_llm/domestic_stock/inquire_member/inquire_member.py |
