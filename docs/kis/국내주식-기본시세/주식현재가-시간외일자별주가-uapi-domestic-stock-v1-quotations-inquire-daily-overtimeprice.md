...
category: "[국내주식] 기본시세"
api_id: "/uapi/domestic-stock/v1/quotations/inquire-daily-overtimeprice"
api_name: "주식현재가 시간외일자별주가"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 기본시세 |
| API path | `/uapi/domestic-stock/v1/quotations/inquire-daily-overtimeprice` |
| 샘플 TR ID | FHPST02320000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/inquire_daily_overtimeprice/inquire_daily_overtimeprice.py |
