...
category: "[국내주식] 기본시세"
api_id: "/uapi/domestic-stock/v1/quotations/inquire-price-2"
api_name: "주식현재가 시세2"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 기본시세 |
| API path | `/uapi/domestic-stock/v1/quotations/inquire-price-2` |
| 샘플 TR ID | FHPST01010000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/inquire_price_2/inquire_price_2.py |
