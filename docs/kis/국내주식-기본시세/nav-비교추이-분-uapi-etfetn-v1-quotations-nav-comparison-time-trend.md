...
category: "[국내주식] 기본시세"
api_id: "/uapi/etfetn/v1/quotations/nav-comparison-time-trend"
api_name: "NAV 비교추이(분)"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 기본시세 |
| API path | `/uapi/etfetn/v1/quotations/nav-comparison-time-trend` |
| 샘플 TR ID | FHPST02440100 |
| 공식 샘플 파일 | examples_llm/etfetn/nav_comparison_time_trend/nav_comparison_time_trend.py |
