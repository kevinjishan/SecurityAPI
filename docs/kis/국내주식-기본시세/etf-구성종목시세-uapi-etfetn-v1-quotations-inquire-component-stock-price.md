...
category: "[국내주식] 기본시세"
api_id: "/uapi/etfetn/v1/quotations/inquire-component-stock-price"
api_name: "ETF 구성종목시세"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 기본시세 |
| API path | `/uapi/etfetn/v1/quotations/inquire-component-stock-price` |
| 샘플 TR ID | FHKST121600C0 |
| 공식 샘플 파일 | examples_llm/etfetn/inquire_component_stock_price/inquire_component_stock_price.py |
