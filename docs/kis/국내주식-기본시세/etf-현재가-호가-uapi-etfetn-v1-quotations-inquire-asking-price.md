...
category: "[국내주식] 기본시세"
api_id: "/uapi/etfetn/v1/quotations/inquire-asking-price"
api_name: "ETF 현재가 호가"
method: "GET"
...
# ETF 현재가 호가 (/uapi/etfetn/v1/quotations/inquire-asking-price)
...
| --- | --- |
| 카테고리 | [국내주식] 기본시세 |
| API path | `/uapi/etfetn/v1/quotations/inquire-asking-price` |
| 샘플 TR ID | - |
| 공식 샘플 파일 | - |
