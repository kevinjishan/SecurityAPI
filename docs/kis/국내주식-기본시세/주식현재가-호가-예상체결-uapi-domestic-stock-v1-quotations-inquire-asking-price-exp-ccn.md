...
category: "[국내주식] 기본시세"
api_id: "/uapi/domestic-stock/v1/quotations/inquire-asking-price-exp-ccn"
api_name: "주식현재가 호가/예상체결"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 기본시세 |
| API path | `/uapi/domestic-stock/v1/quotations/inquire-asking-price-exp-ccn` |
| 샘플 TR ID | FHKST01010200 |
| 공식 샘플 파일 | examples_llm/domestic_stock/inquire_asking_price_exp_ccn/inquire_asking_price_exp_ccn.py |
