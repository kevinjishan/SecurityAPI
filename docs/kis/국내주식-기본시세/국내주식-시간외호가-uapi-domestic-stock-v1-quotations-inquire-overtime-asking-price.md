...
category: "[국내주식] 기본시세"
api_id: "/uapi/domestic-stock/v1/quotations/inquire-overtime-asking-price"
api_name: "국내주식 시간외호가"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 기본시세 |
| API path | `/uapi/domestic-stock/v1/quotations/inquire-overtime-asking-price` |
| 샘플 TR ID | FHPST02300400 |
| 공식 샘플 파일 | examples_llm/domestic_stock/inquire_overtime_asking_price/inquire_overtime_asking_price.py |
