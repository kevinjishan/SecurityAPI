...
category: "[국내주식] 기본시세"
api_id: "/uapi/domestic-stock/v1/quotations/inquire-time-dailychartprice"
api_name: "주식일별분봉조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 기본시세 |
| API path | `/uapi/domestic-stock/v1/quotations/inquire-time-dailychartprice` |
| 샘플 TR ID | FHKST03010230 |
| 공식 샘플 파일 | examples_llm/domestic_stock/inquire_time_dailychartprice/inquire_time_dailychartprice.py |
