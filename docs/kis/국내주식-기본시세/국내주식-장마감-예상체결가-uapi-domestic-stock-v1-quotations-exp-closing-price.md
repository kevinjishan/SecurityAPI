...
category: "[국내주식] 기본시세"
api_id: "/uapi/domestic-stock/v1/quotations/exp-closing-price"
api_name: "국내주식 장마감 예상체결가"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 기본시세 |
| API path | `/uapi/domestic-stock/v1/quotations/exp-closing-price` |
| 샘플 TR ID | FHKST117300C0 |
| 공식 샘플 파일 | examples_llm/domestic_stock/exp_closing_price/exp_closing_price.py |
