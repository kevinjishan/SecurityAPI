...
category: "[국내주식] 기본시세"
api_id: "/uapi/etfetn/v1/quotations/inquire-price"
api_name: "ETF/ETN 현재가"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 기본시세 |
| API path | `/uapi/etfetn/v1/quotations/inquire-price` |
| 샘플 TR ID | FHPST02400000 |
| 공식 샘플 파일 | examples_llm/etfetn/inquire_price/inquire_price.py |
