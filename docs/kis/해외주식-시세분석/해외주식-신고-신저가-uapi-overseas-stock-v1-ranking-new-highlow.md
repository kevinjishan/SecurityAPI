...
category: "[해외주식] 시세분석"
api_id: "/uapi/overseas-stock/v1/ranking/new-highlow"
api_name: "해외주식 신고/신저가"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 시세분석 |
| API path | `/uapi/overseas-stock/v1/ranking/new-highlow` |
| 샘플 TR ID | HHDFS76300000 |
| 공식 샘플 파일 | examples_llm/overseas_stock/new_highlow/new_highlow.py |
