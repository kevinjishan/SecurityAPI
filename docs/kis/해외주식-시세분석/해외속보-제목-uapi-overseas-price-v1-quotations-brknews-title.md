...
category: "[해외주식] 시세분석"
api_id: "/uapi/overseas-price/v1/quotations/brknews-title"
api_name: "해외속보(제목)"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 시세분석 |
| API path | `/uapi/overseas-price/v1/quotations/brknews-title` |
| 샘플 TR ID | FHKST01011801 |
| 공식 샘플 파일 | examples_llm/overseas_stock/brknews_title/brknews_title.py |
