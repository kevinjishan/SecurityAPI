...
category: "[해외주식] 시세분석"
api_id: "/uapi/overseas-stock/v1/ranking/volume-surge"
api_name: "해외주식 거래량급증"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 시세분석 |
| API path | `/uapi/overseas-stock/v1/ranking/volume-surge` |
| 샘플 TR ID | HHDFS76270000 |
| 공식 샘플 파일 | examples_llm/overseas_stock/volume_surge/volume_surge.py |
