...
category: "[해외주식] 시세분석"
api_id: "/uapi/overseas-stock/v1/ranking/trade-growth"
api_name: "해외주식 거래증가율순위"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 시세분석 |
| API path | `/uapi/overseas-stock/v1/ranking/trade-growth` |
| 샘플 TR ID | HHDFS76330000 |
| 공식 샘플 파일 | examples_llm/overseas_stock/trade_growth/trade_growth.py |
