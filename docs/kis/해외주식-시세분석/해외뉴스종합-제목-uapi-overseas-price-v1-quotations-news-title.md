...
category: "[해외주식] 시세분석"
api_id: "/uapi/overseas-price/v1/quotations/news-title"
api_name: "해외뉴스종합(제목)"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 시세분석 |
| API path | `/uapi/overseas-price/v1/quotations/news-title` |
| 샘플 TR ID | HHPSTH60100C1 |
| 공식 샘플 파일 | examples_llm/overseas_stock/news_title/news_title.py |
...
| 위치 | 필드 | 필수 |
| --- | --- | --- |
| Query/Body | `INFO_GB` | Y |
| Query/Body | `CLASS_CD` | Y |
| Query/Body | `NATION_CD` | Y |
| Query/Body | `EXCHANGE_CD` | Y |
| Query/Body | `SYMB` | Y |
| Query/Body | `DATA_DT` | Y |
| Query/Body | `DATA_TM` | Y |
| Query/Body | `CTS` | Y |
