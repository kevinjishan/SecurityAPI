...
category: "[해외주식] 시세분석"
api_id: "/uapi/overseas-price/v1/quotations/rights-by-ice"
api_name: "해외주식 권리종합"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 시세분석 |
| API path | `/uapi/overseas-price/v1/quotations/rights-by-ice` |
| 샘플 TR ID | HHDFS78330900 |
| 공식 샘플 파일 | examples_llm/overseas_stock/rights_by_ice/rights_by_ice.py |
