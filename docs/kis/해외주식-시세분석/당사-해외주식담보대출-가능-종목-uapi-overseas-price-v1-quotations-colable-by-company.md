...
category: "[해외주식] 시세분석"
api_id: "/uapi/overseas-price/v1/quotations/colable-by-company"
api_name: "당사 해외주식담보대출 가능 종목"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 시세분석 |
| API path | `/uapi/overseas-price/v1/quotations/colable-by-company` |
| 샘플 TR ID | CTLN4050R |
| 공식 샘플 파일 | examples_llm/overseas_stock/colable_by_company/colable_by_company.py |
