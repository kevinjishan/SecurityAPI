...
category: "[해외주식] 시세분석"
api_id: "/uapi/overseas-stock/v1/ranking/trade-vol"
api_name: "해외주식 거래량순위"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 시세분석 |
| API path | `/uapi/overseas-stock/v1/ranking/trade-vol` |
| 샘플 TR ID | HHDFS76310010 |
| 공식 샘플 파일 | examples_llm/overseas_stock/trade_vol/trade_vol.py |
