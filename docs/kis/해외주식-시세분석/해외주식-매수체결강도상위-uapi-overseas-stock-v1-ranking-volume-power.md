...
category: "[해외주식] 시세분석"
api_id: "/uapi/overseas-stock/v1/ranking/volume-power"
api_name: "해외주식 매수체결강도상위"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 시세분석 |
| API path | `/uapi/overseas-stock/v1/ranking/volume-power` |
| 샘플 TR ID | HHDFS76280000 |
| 공식 샘플 파일 | examples_llm/overseas_stock/volume_power/volume_power.py |
