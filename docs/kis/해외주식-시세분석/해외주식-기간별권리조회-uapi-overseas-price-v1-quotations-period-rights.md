...
category: "[해외주식] 시세분석"
api_id: "/uapi/overseas-price/v1/quotations/period-rights"
api_name: "해외주식 기간별권리조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 시세분석 |
| API path | `/uapi/overseas-price/v1/quotations/period-rights` |
| 샘플 TR ID | CTRGT011R |
| 공식 샘플 파일 | examples_llm/overseas_stock/period_rights/period_rights.py |
...
| Query/Body | `CTX_AREA_NK50` | Y |
| Query/Body | `CTX_AREA_FK50` | Y |
