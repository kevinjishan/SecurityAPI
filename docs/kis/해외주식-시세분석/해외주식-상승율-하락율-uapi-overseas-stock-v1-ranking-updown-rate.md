...
category: "[해외주식] 시세분석"
api_id: "/uapi/overseas-stock/v1/ranking/updown-rate"
api_name: "해외주식 상승율/하락율"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 시세분석 |
| API path | `/uapi/overseas-stock/v1/ranking/updown-rate` |
| 샘플 TR ID | HHDFS76290000 |
| 공식 샘플 파일 | examples_llm/overseas_stock/updown_rate/updown_rate.py |
