...
category: "[해외주식] 시세분석"
api_id: "/uapi/overseas-stock/v1/ranking/market-cap"
api_name: "해외주식 시가총액순위"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 시세분석 |
| API path | `/uapi/overseas-stock/v1/ranking/market-cap` |
| 샘플 TR ID | HHDFS76350100 |
| 공식 샘플 파일 | examples_llm/overseas_stock/market_cap/market_cap.py |
