...
category: "[해외주식] 시세분석"
api_id: "/uapi/overseas-stock/v1/ranking/trade-pbmn"
api_name: "해외주식 거래대금순위"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 시세분석 |
| API path | `/uapi/overseas-stock/v1/ranking/trade-pbmn` |
| 샘플 TR ID | HHDFS76320010 |
| 공식 샘플 파일 | examples_llm/overseas_stock/trade_pbmn/trade_pbmn.py |
