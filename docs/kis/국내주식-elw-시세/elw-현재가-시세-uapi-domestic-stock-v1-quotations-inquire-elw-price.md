...
api_id: "/uapi/domestic-stock/v1/quotations/inquire-elw-price"
api_name: "ELW 현재가 시세"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] ELW 시세 |
| API path | `/uapi/domestic-stock/v1/quotations/inquire-elw-price` |
| 샘플 TR ID | FHKEW15010000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/inquire_elw_price/inquire_elw_price.py |
