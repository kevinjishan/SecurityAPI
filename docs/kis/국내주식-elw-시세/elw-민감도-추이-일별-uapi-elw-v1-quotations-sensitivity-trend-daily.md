...
api_id: "/uapi/elw/v1/quotations/sensitivity-trend-daily"
api_name: "ELW 민감도 추이(일별)"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] ELW 시세 |
| API path | `/uapi/elw/v1/quotations/sensitivity-trend-daily` |
| 샘플 TR ID | FHPEW02830200 |
| 공식 샘플 파일 | examples_llm/elw/sensitivity_trend_daily/sensitivity_trend_daily.py |
