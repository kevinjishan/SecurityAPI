...
api_id: "/uapi/elw/v1/quotations/udrl-asset-list"
api_name: "ELW 기초자산 목록조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] ELW 시세 |
| API path | `/uapi/elw/v1/quotations/udrl-asset-list` |
| 샘플 TR ID | FHKEW154100C0 |
| 공식 샘플 파일 | examples_llm/elw/udrl_asset_list/udrl_asset_list.py |
