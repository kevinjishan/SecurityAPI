...
api_id: "/uapi/elw/v1/quotations/volatility-trend-minute"
api_name: "ELW 변동성 추이(분별)"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] ELW 시세 |
| API path | `/uapi/elw/v1/quotations/volatility-trend-minute` |
| 샘플 TR ID | FHPEW02840300 |
| 공식 샘플 파일 | examples_llm/elw/volatility_trend_minute/volatility_trend_minute.py |
