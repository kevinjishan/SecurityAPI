...
api_id: "/uapi/elw/v1/quotations/indicator-trend-ccnl"
api_name: "ELW 투자지표추이(체결)"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] ELW 시세 |
| API path | `/uapi/elw/v1/quotations/indicator-trend-ccnl` |
| 샘플 TR ID | FHPEW02740100 |
| 공식 샘플 파일 | examples_llm/elw/indicator_trend_ccnl/indicator_trend_ccnl.py |
