...
api_id: "/uapi/elw/v1/quotations/expiration-stocks"
api_name: "ELW 만기예정/만기종목"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] ELW 시세 |
| API path | `/uapi/elw/v1/quotations/expiration-stocks` |
| 샘플 TR ID | FHKEW154700C0 |
| 공식 샘플 파일 | examples_llm/elw/expiration_stocks/expiration_stocks.py |
