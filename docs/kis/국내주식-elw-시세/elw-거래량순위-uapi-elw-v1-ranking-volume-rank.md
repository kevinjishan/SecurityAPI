...
api_id: "/uapi/elw/v1/ranking/volume-rank"
api_name: "ELW 거래량순위"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] ELW 시세 |
| API path | `/uapi/elw/v1/ranking/volume-rank` |
| 샘플 TR ID | FHPEW02780000 |
| 공식 샘플 파일 | examples_llm/elw/volume_rank/volume_rank.py |
