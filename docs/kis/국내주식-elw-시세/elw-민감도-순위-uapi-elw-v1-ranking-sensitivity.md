...
api_id: "/uapi/elw/v1/ranking/sensitivity"
api_name: "ELW 민감도 순위"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] ELW 시세 |
| API path | `/uapi/elw/v1/ranking/sensitivity` |
| 샘플 TR ID | FHPEW02850000 |
| 공식 샘플 파일 | examples_llm/elw/sensitivity/sensitivity.py |
