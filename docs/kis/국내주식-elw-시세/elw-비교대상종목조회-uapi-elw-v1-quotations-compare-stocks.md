...
api_id: "/uapi/elw/v1/quotations/compare-stocks"
api_name: "ELW 비교대상종목조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] ELW 시세 |
| API path | `/uapi/elw/v1/quotations/compare-stocks` |
| 샘플 TR ID | FHKEW151701C0 |
| 공식 샘플 파일 | examples_llm/elw/compare_stocks/compare_stocks.py |
