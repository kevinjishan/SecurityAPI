...
api_id: "/uapi/elw/v1/quotations/newly-listed"
api_name: "ELW 신규상장종목"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] ELW 시세 |
| API path | `/uapi/elw/v1/quotations/newly-listed` |
| 샘플 TR ID | FHKEW154800C0 |
| 공식 샘플 파일 | examples_llm/elw/newly_listed/newly_listed.py |
