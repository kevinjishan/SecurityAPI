...
api_id: "/uapi/elw/v1/quotations/indicator-trend-daily"
api_name: "ELW 투자지표추이(일별)"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] ELW 시세 |
| API path | `/uapi/elw/v1/quotations/indicator-trend-daily` |
| 샘플 TR ID | FHPEW02740200 |
| 공식 샘플 파일 | examples_llm/elw/indicator_trend_daily/indicator_trend_daily.py |
