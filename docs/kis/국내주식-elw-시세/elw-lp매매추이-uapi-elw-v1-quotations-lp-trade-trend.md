...
api_id: "/uapi/elw/v1/quotations/lp-trade-trend"
api_name: "ELW LP매매추이"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] ELW 시세 |
| API path | `/uapi/elw/v1/quotations/lp-trade-trend` |
| 샘플 TR ID | FHPEW03760000 |
| 공식 샘플 파일 | examples_llm/elw/lp_trade_trend/lp_trade_trend.py |
