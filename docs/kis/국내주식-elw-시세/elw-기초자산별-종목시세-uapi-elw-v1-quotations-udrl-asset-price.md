...
api_id: "/uapi/elw/v1/quotations/udrl-asset-price"
api_name: "ELW 기초자산별 종목시세"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] ELW 시세 |
| API path | `/uapi/elw/v1/quotations/udrl-asset-price` |
| 샘플 TR ID | FHKEW154101C0 |
| 공식 샘플 파일 | examples_llm/elw/udrl_asset_price/udrl_asset_price.py |
...
| Query/Body | `FID_VOL_CNT` | Y |
| Query/Body | `FID_TRGT_EXLS_CLS_CODE` | Y |
...
| Query/Body | `FID_OPTION` | Y |
| Query/Body | `FID_INPUT_OPTION_1` | Y |
| Query/Body | `FID_INPUT_OPTION_2` | Y |
