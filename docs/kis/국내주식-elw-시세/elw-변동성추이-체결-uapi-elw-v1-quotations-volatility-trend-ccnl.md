...
api_id: "/uapi/elw/v1/quotations/volatility-trend-ccnl"
api_name: "ELW 변동성추이(체결)"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] ELW 시세 |
| API path | `/uapi/elw/v1/quotations/volatility-trend-ccnl` |
| 샘플 TR ID | FHPEW02840100 |
| 공식 샘플 파일 | examples_llm/elw/volatility_trend_ccnl/volatility_trend_ccnl.py |
