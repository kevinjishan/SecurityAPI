...
category: "[국내주식] 시세분석"
api_id: "/uapi/domestic-stock/v1/quotations/comp-program-trade-today"
api_name: "프로그램매매 종합현황(시간)"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 시세분석 |
| API path | `/uapi/domestic-stock/v1/quotations/comp-program-trade-today` |
| 샘플 TR ID | FHPPG04600101 |
| 공식 샘플 파일 | examples_llm/domestic_stock/comp_program_trade_today/comp_program_trade_today.py |
...
| Query/Body | `FID_SCTN_CLS_CODE` | Y |
| Query/Body | `FID_INPUT_ISCD` | Y |
| Query/Body | `FID_COND_MRKT_DIV_CODE1` | Y |
