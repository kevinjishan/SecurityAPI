...
category: "[국내주식] 시세분석"
api_id: "/uapi/domestic-stock/v1/quotations/investor-program-trade-today"
api_name: "프로그램매매 투자자매매동향(당일)"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 시세분석 |
| API path | `/uapi/domestic-stock/v1/quotations/investor-program-trade-today` |
| 샘플 TR ID | HHPPG046600C1 |
| 공식 샘플 파일 | examples_llm/domestic_stock/investor_program_trade_today/investor_program_trade_today.py |
