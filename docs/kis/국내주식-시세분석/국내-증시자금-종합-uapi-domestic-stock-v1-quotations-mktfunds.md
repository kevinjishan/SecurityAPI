...
category: "[국내주식] 시세분석"
api_id: "/uapi/domestic-stock/v1/quotations/mktfunds"
api_name: "국내 증시자금 종합"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 시세분석 |
| API path | `/uapi/domestic-stock/v1/quotations/mktfunds` |
| 샘플 TR ID | FHKST649100C0 |
| 공식 샘플 파일 | examples_llm/domestic_stock/mktfunds/mktfunds.py |
