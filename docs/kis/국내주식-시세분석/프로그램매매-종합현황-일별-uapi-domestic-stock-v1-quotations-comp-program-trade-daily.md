...
category: "[국내주식] 시세분석"
api_id: "/uapi/domestic-stock/v1/quotations/comp-program-trade-daily"
api_name: "프로그램매매 종합현황(일별)"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 시세분석 |
| API path | `/uapi/domestic-stock/v1/quotations/comp-program-trade-daily` |
| 샘플 TR ID | FHPPG04600001 |
| 공식 샘플 파일 | examples_llm/domestic_stock/comp_program_trade_daily/comp_program_trade_daily.py |
