...
category: "[국내주식] 시세분석"
api_id: "/uapi/domestic-stock/v1/quotations/intstock-stocklist-by-group"
api_name: "관심종목 그룹별 종목조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 시세분석 |
| API path | `/uapi/domestic-stock/v1/quotations/intstock-stocklist-by-group` |
| 샘플 TR ID | HHKCM113004C6 |
| 공식 샘플 파일 | examples_llm/domestic_stock/intstock_stocklist_by_group/intstock_stocklist_by_group.py |
...
| --- | --- | --- |
| Query/Body | `TYPE` | Y |
| Query/Body | `USER_ID` | Y |
| Query/Body | `INTER_GRP_CODE` | Y |
| Query/Body | `FID_ETC_CLS_CODE` | Y |
| Query/Body | `DATA_RANK` | Y |
| Query/Body | `INTER_GRP_NAME` | Y |
| Query/Body | `HTS_KOR_ISNM` | Y |
| Query/Body | `CNTG_CLS_CODE` | Y |
