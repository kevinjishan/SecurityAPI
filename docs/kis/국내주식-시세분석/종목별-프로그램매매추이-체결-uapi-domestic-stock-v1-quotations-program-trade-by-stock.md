...
category: "[국내주식] 시세분석"
api_id: "/uapi/domestic-stock/v1/quotations/program-trade-by-stock"
api_name: "종목별 프로그램매매추이(체결)"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 시세분석 |
| API path | `/uapi/domestic-stock/v1/quotations/program-trade-by-stock` |
| 샘플 TR ID | FHPPG04650101 |
| 공식 샘플 파일 | examples_llm/domestic_stock/program_trade_by_stock/program_trade_by_stock.py |
