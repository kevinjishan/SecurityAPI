...
category: "[국내주식] 시세분석"
api_id: "/uapi/domestic-stock/v1/quotations/tradprt-byamt"
api_name: "국내주식 체결금액별 매매비중"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 시세분석 |
| API path | `/uapi/domestic-stock/v1/quotations/tradprt-byamt` |
| 샘플 TR ID | FHKST111900C0 |
| 공식 샘플 파일 | examples_llm/domestic_stock/tradprt_byamt/tradprt_byamt.py |
