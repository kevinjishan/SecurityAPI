...
category: "[국내주식] 시세분석"
api_id: "/uapi/domestic-stock/v1/quotations/foreign-institution-total"
api_name: "국내기관_외국인 매매종목가집계"
method: "GET"
...
# 국내기관_외국인 매매종목가집계 (/uapi/domestic-stock/v1/quotations/foreign-institution-total)
...
| --- | --- |
| 카테고리 | [국내주식] 시세분석 |
| API path | `/uapi/domestic-stock/v1/quotations/foreign-institution-total` |
| 샘플 TR ID | FHPTJ04400000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/foreign_institution_total/foreign_institution_total.py |
