...
category: "[국내주식] 시세분석"
api_id: "/uapi/domestic-stock/v1/quotations/inquire-member-daily"
api_name: "주식현재가 회원사 종목매매동향"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 시세분석 |
| API path | `/uapi/domestic-stock/v1/quotations/inquire-member-daily` |
| 샘플 TR ID | FHPST04540000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/inquire_member_daily/inquire_member_daily.py |
