...
category: "[국내주식] 시세분석"
api_id: "/uapi/domestic-stock/v1/quotations/daily-credit-balance"
api_name: "국내주식 신용잔고 일별추이"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 시세분석 |
| API path | `/uapi/domestic-stock/v1/quotations/daily-credit-balance` |
| 샘플 TR ID | FHPST04760000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/daily_credit_balance/daily_credit_balance.py |
