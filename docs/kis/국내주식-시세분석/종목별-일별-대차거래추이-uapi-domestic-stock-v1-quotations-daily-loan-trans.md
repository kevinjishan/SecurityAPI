...
category: "[국내주식] 시세분석"
api_id: "/uapi/domestic-stock/v1/quotations/daily-loan-trans"
api_name: "종목별 일별 대차거래추이"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 시세분석 |
| API path | `/uapi/domestic-stock/v1/quotations/daily-loan-trans` |
| 샘플 TR ID | HHPST074500C0 |
| 공식 샘플 파일 | examples_llm/domestic_stock/daily_loan_trans/daily_loan_trans.py |
...
| 위치 | 필드 | 필수 |
| --- | --- | --- |
| Query/Body | `MRKT_DIV_CLS_CODE` | Y |
| Query/Body | `MKSC_SHRN_ISCD` | Y |
| Query/Body | `START_DATE` | Y |
| Query/Body | `END_DATE` | Y |
| Query/Body | `CTS` | Y |
