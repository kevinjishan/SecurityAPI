...
category: "[국내주식] 시세분석"
api_id: "/uapi/domestic-stock/v1/quotations/psearch-title"
api_name: "종목조건검색 목록조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 시세분석 |
| API path | `/uapi/domestic-stock/v1/quotations/psearch-title` |
| 샘플 TR ID | HHKST03900300 |
| 공식 샘플 파일 | examples_llm/domestic_stock/psearch_title/psearch_title.py |
