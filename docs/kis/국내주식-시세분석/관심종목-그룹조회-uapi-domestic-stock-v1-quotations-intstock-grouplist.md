...
category: "[국내주식] 시세분석"
api_id: "/uapi/domestic-stock/v1/quotations/intstock-grouplist"
api_name: "관심종목 그룹조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 시세분석 |
| API path | `/uapi/domestic-stock/v1/quotations/intstock-grouplist` |
| 샘플 TR ID | HHKCM113004C7 |
| 공식 샘플 파일 | examples_llm/domestic_stock/intstock_grouplist/intstock_grouplist.py |
