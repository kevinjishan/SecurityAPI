...
category: "[국내주식] 시세분석"
api_id: "/uapi/domestic-stock/v1/ranking/overtime-exp-trans-fluct"
api_name: "국내주식 시간외예상체결등락률"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 시세분석 |
| API path | `/uapi/domestic-stock/v1/ranking/overtime-exp-trans-fluct` |
| 샘플 TR ID | FHKST11860000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/overtime_exp_trans_fluct/overtime_exp_trans_fluct.py |
