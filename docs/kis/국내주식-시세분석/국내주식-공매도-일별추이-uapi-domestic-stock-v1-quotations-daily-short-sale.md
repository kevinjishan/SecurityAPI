...
category: "[국내주식] 시세분석"
api_id: "/uapi/domestic-stock/v1/quotations/daily-short-sale"
api_name: "국내주식 공매도 일별추이"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 시세분석 |
| API path | `/uapi/domestic-stock/v1/quotations/daily-short-sale` |
| 샘플 TR ID | FHPST04830000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/daily_short_sale/daily_short_sale.py |
