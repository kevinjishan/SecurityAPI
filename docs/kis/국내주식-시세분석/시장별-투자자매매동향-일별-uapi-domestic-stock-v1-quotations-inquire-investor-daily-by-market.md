...
category: "[국내주식] 시세분석"
api_id: "/uapi/domestic-stock/v1/quotations/inquire-investor-daily-by-market"
api_name: "시장별 투자자매매동향(일별)"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 시세분석 |
| API path | `/uapi/domestic-stock/v1/quotations/inquire-investor-daily-by-market` |
| 샘플 TR ID | FHPTJ04040000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/inquire_investor_daily_by_market/inquire_investor_daily_by_market.py |
