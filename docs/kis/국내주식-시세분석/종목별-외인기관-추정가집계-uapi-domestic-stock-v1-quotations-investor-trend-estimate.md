...
category: "[국내주식] 시세분석"
api_id: "/uapi/domestic-stock/v1/quotations/investor-trend-estimate"
api_name: "종목별 외인기관 추정가집계"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 시세분석 |
| API path | `/uapi/domestic-stock/v1/quotations/investor-trend-estimate` |
| 샘플 TR ID | HHPTJ04160200 |
| 공식 샘플 파일 | examples_llm/domestic_stock/investor_trend_estimate/investor_trend_estimate.py |
