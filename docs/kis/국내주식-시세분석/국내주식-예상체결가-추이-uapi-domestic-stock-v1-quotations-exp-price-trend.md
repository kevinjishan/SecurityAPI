...
category: "[국내주식] 시세분석"
api_id: "/uapi/domestic-stock/v1/quotations/exp-price-trend"
api_name: "국내주식 예상체결가 추이"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 시세분석 |
| API path | `/uapi/domestic-stock/v1/quotations/exp-price-trend` |
| 샘플 TR ID | FHPST01810000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/exp_price_trend/exp_price_trend.py |
