...
category: "[국내주식] 시세분석"
api_id: "/uapi/domestic-stock/v1/quotations/frgnmem-trade-estimate"
api_name: "외국계 매매종목 가집계"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 시세분석 |
| API path | `/uapi/domestic-stock/v1/quotations/frgnmem-trade-estimate` |
| 샘플 TR ID | FHKST644100C0 |
| 공식 샘플 파일 | examples_llm/domestic_stock/frgnmem_trade_estimate/frgnmem_trade_estimate.py |
