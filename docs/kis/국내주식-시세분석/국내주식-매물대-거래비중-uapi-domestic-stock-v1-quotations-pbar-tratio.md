...
category: "[국내주식] 시세분석"
api_id: "/uapi/domestic-stock/v1/quotations/pbar-tratio"
api_name: "국내주식 매물대/거래비중"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 시세분석 |
| API path | `/uapi/domestic-stock/v1/quotations/pbar-tratio` |
| 샘플 TR ID | FHPST01130000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/pbar_tratio/pbar_tratio.py |
