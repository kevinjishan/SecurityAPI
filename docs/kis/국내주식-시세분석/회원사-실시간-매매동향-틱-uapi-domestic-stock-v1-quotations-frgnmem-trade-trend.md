...
category: "[국내주식] 시세분석"
api_id: "/uapi/domestic-stock/v1/quotations/frgnmem-trade-trend"
api_name: "회원사 실시간 매매동향(틱)"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 시세분석 |
| API path | `/uapi/domestic-stock/v1/quotations/frgnmem-trade-trend` |
| 샘플 TR ID | FHPST04320000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/frgnmem_trade_trend/frgnmem_trade_trend.py |
