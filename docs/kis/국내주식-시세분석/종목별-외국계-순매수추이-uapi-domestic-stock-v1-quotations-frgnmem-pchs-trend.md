...
category: "[국내주식] 시세분석"
api_id: "/uapi/domestic-stock/v1/quotations/frgnmem-pchs-trend"
api_name: "종목별 외국계 순매수추이"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 시세분석 |
| API path | `/uapi/domestic-stock/v1/quotations/frgnmem-pchs-trend` |
| 샘플 TR ID | FHKST644400C0 |
| 공식 샘플 파일 | examples_llm/domestic_stock/frgnmem_pchs_trend/frgnmem_pchs_trend.py |
