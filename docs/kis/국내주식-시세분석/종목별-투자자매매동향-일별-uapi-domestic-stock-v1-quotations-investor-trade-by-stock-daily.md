...
category: "[국내주식] 시세분석"
api_id: "/uapi/domestic-stock/v1/quotations/investor-trade-by-stock-daily"
api_name: "종목별 투자자매매동향(일별)"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 시세분석 |
| API path | `/uapi/domestic-stock/v1/quotations/investor-trade-by-stock-daily` |
| 샘플 TR ID | FHPTJ04160001 |
| 공식 샘플 파일 | examples_llm/domestic_stock/investor_trade_by_stock_daily/investor_trade_by_stock_daily.py |
