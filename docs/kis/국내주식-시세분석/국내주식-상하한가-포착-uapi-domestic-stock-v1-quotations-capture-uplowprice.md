...
category: "[국내주식] 시세분석"
api_id: "/uapi/domestic-stock/v1/quotations/capture-uplowprice"
api_name: "국내주식 상하한가 포착"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 시세분석 |
| API path | `/uapi/domestic-stock/v1/quotations/capture-uplowprice` |
| 샘플 TR ID | FHKST130000C0 |
| 공식 샘플 파일 | examples_llm/domestic_stock/capture_uplowprice/capture_uplowprice.py |
