...
category: "[국내주식] 시세분석"
api_id: "/uapi/domestic-stock/v1/quotations/inquire-daily-trade-volume"
api_name: "종목별일별매수매도체결량"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 시세분석 |
| API path | `/uapi/domestic-stock/v1/quotations/inquire-daily-trade-volume` |
| 샘플 TR ID | FHKST03010800 |
| 공식 샘플 파일 | examples_llm/domestic_stock/inquire_daily_trade_volume/inquire_daily_trade_volume.py |
