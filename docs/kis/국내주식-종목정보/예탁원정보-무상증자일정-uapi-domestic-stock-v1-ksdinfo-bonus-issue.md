...
category: "[국내주식] 종목정보"
api_id: "/uapi/domestic-stock/v1/ksdinfo/bonus-issue"
api_name: "예탁원정보(무상증자일정)"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 종목정보 |
| API path | `/uapi/domestic-stock/v1/ksdinfo/bonus-issue` |
| 샘플 TR ID | HHKDB669101C0 |
| 공식 샘플 파일 | examples_llm/domestic_stock/ksdinfo_bonus_issue/ksdinfo_bonus_issue.py |
