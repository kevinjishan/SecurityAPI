...
category: "[국내주식] 종목정보"
api_id: "/uapi/domestic-stock/v1/quotations/lendable-by-company"
api_name: "당사 대주가능 종목"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 종목정보 |
| API path | `/uapi/domestic-stock/v1/quotations/lendable-by-company` |
| 샘플 TR ID | CTSC2702R |
| 공식 샘플 파일 | examples_llm/domestic_stock/lendable_by_company/lendable_by_company.py |
...
| 위치 | 필드 | 필수 |
| --- | --- | --- |
| Query/Body | `EXCG_DVSN_CD` | Y |
| Query/Body | `PDNO` | Y |
| Query/Body | `THCO_STLN_PSBL_YN` | Y |
