...
category: "[국내주식] 종목정보"
api_id: "/uapi/domestic-stock/v1/quotations/credit-by-company"
api_name: "국내주식 당사 신용가능종목"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 종목정보 |
| API path | `/uapi/domestic-stock/v1/quotations/credit-by-company` |
| 샘플 TR ID | FHPST04770000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/credit_by_company/credit_by_company.py |
