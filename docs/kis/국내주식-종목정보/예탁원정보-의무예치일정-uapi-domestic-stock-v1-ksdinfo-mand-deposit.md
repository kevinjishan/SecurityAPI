...
category: "[국내주식] 종목정보"
api_id: "/uapi/domestic-stock/v1/ksdinfo/mand-deposit"
api_name: "예탁원정보(의무예치일정)"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 종목정보 |
| API path | `/uapi/domestic-stock/v1/ksdinfo/mand-deposit` |
| 샘플 TR ID | HHKDB669110C0 |
| 공식 샘플 파일 | examples_llm/domestic_stock/ksdinfo_mand_deposit/ksdinfo_mand_deposit.py |
