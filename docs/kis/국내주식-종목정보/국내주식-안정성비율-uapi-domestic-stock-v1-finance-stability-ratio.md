...
category: "[국내주식] 종목정보"
api_id: "/uapi/domestic-stock/v1/finance/stability-ratio"
api_name: "국내주식 안정성비율"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 종목정보 |
| API path | `/uapi/domestic-stock/v1/finance/stability-ratio` |
| 샘플 TR ID | FHKST66430600 |
| 공식 샘플 파일 | examples_llm/domestic_stock/finance_stability_ratio/finance_stability_ratio.py |
