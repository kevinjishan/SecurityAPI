...
category: "[국내주식] 종목정보"
api_id: "/uapi/domestic-stock/v1/quotations/estimate-perform"
api_name: "국내주식 종목추정실적"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 종목정보 |
| API path | `/uapi/domestic-stock/v1/quotations/estimate-perform` |
| 샘플 TR ID | HHKST668300C0 |
| 공식 샘플 파일 | examples_llm/domestic_stock/estimate_perform/estimate_perform.py |
