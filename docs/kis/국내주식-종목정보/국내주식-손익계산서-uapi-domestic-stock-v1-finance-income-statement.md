...
category: "[국내주식] 종목정보"
api_id: "/uapi/domestic-stock/v1/finance/income-statement"
api_name: "국내주식 손익계산서"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 종목정보 |
| API path | `/uapi/domestic-stock/v1/finance/income-statement` |
| 샘플 TR ID | FHKST66430200 |
| 공식 샘플 파일 | examples_llm/domestic_stock/finance_income_statement/finance_income_statement.py |
