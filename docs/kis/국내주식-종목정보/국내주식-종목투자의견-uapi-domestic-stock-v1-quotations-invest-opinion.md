...
category: "[국내주식] 종목정보"
api_id: "/uapi/domestic-stock/v1/quotations/invest-opinion"
api_name: "국내주식 종목투자의견"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 종목정보 |
| API path | `/uapi/domestic-stock/v1/quotations/invest-opinion` |
| 샘플 TR ID | FHKST663300C0 |
| 공식 샘플 파일 | examples_llm/domestic_stock/invest_opinion/invest_opinion.py |
