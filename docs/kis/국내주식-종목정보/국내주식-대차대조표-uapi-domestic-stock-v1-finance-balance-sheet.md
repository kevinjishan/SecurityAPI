...
category: "[국내주식] 종목정보"
api_id: "/uapi/domestic-stock/v1/finance/balance-sheet"
api_name: "국내주식 대차대조표"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 종목정보 |
| API path | `/uapi/domestic-stock/v1/finance/balance-sheet` |
| 샘플 TR ID | FHKST66430100 |
| 공식 샘플 파일 | examples_llm/domestic_stock/finance_balance_sheet/finance_balance_sheet.py |
