...
category: "[국내주식] 종목정보"
api_id: "/uapi/domestic-stock/v1/finance/profit-ratio"
api_name: "국내주식 수익성비율"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 종목정보 |
| API path | `/uapi/domestic-stock/v1/finance/profit-ratio` |
| 샘플 TR ID | FHKST66430400 |
| 공식 샘플 파일 | examples_llm/domestic_stock/finance_profit_ratio/finance_profit_ratio.py |
