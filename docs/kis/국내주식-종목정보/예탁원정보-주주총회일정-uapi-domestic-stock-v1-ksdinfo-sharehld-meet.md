...
category: "[국내주식] 종목정보"
api_id: "/uapi/domestic-stock/v1/ksdinfo/sharehld-meet"
api_name: "예탁원정보(주주총회일정)"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 종목정보 |
| API path | `/uapi/domestic-stock/v1/ksdinfo/sharehld-meet` |
| 샘플 TR ID | HHKDB669111C0 |
| 공식 샘플 파일 | examples_llm/domestic_stock/ksdinfo_sharehld_meet/ksdinfo_sharehld_meet.py |
