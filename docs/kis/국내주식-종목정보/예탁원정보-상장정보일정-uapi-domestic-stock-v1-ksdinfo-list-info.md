...
category: "[국내주식] 종목정보"
api_id: "/uapi/domestic-stock/v1/ksdinfo/list-info"
api_name: "예탁원정보(상장정보일정)"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 종목정보 |
| API path | `/uapi/domestic-stock/v1/ksdinfo/list-info` |
| 샘플 TR ID | HHKDB669107C0 |
| 공식 샘플 파일 | examples_llm/domestic_stock/ksdinfo_list_info/ksdinfo_list_info.py |
