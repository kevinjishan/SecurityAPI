...
category: "[국내주식] 종목정보"
api_id: "/uapi/domestic-stock/v1/ksdinfo/purreq"
api_name: "예탁원정보(주식매수청구일정)"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 종목정보 |
| API path | `/uapi/domestic-stock/v1/ksdinfo/purreq` |
| 샘플 TR ID | HHKDB669103C0 |
| 공식 샘플 파일 | examples_llm/domestic_stock/ksdinfo_purreq/ksdinfo_purreq.py |
