...
category: "[국내주식] 종목정보"
api_id: "/uapi/domestic-stock/v1/ksdinfo/pub-offer"
api_name: "예탁원정보(공모주청약일정)"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 종목정보 |
| API path | `/uapi/domestic-stock/v1/ksdinfo/pub-offer` |
| 샘플 TR ID | HHKDB669108C0 |
| 공식 샘플 파일 | examples_llm/domestic_stock/ksdinfo_pub_offer/ksdinfo_pub_offer.py |
