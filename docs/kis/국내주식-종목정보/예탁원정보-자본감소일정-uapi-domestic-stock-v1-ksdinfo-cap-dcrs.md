...
category: "[국내주식] 종목정보"
api_id: "/uapi/domestic-stock/v1/ksdinfo/cap-dcrs"
api_name: "예탁원정보(자본감소일정)"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 종목정보 |
| API path | `/uapi/domestic-stock/v1/ksdinfo/cap-dcrs` |
| 샘플 TR ID | HHKDB669106C0 |
| 공식 샘플 파일 | examples_llm/domestic_stock/ksdinfo_cap_dcrs/ksdinfo_cap_dcrs.py |
