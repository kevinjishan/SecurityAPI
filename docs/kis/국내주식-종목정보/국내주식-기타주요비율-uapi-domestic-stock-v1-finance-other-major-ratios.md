...
category: "[국내주식] 종목정보"
api_id: "/uapi/domestic-stock/v1/finance/other-major-ratios"
api_name: "국내주식 기타주요비율"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 종목정보 |
| API path | `/uapi/domestic-stock/v1/finance/other-major-ratios` |
| 샘플 TR ID | FHKST66430500 |
| 공식 샘플 파일 | examples_llm/domestic_stock/finance_other_major_ratios/finance_other_major_ratios.py |
