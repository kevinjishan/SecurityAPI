...
api_id: "/uapi/domestic-futureoption/v1/trading/ngt-margin-detail"
api_name: "(야간)선물옵션 증거금 상세"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내선물옵션] 주문/계좌 |
| API path | `/uapi/domestic-futureoption/v1/trading/ngt-margin-detail` |
| 샘플 TR ID | CTFN7107R |
| 공식 샘플 파일 | examples_llm/domestic_futureoption/ngt_margin_detail/ngt_margin_detail.py |
