...
api_id: "/uapi/domestic-futureoption/v1/trading/inquire-balance-valuation-pl"
api_name: "선물옵션 잔고평가손익내역"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내선물옵션] 주문/계좌 |
| API path | `/uapi/domestic-futureoption/v1/trading/inquire-balance-valuation-pl` |
| 샘플 TR ID | CTFO6159R |
| 공식 샘플 파일 | examples_llm/domestic_futureoption/inquire_balance_valuation_pl/inquire_balance_valuation_pl.py |
