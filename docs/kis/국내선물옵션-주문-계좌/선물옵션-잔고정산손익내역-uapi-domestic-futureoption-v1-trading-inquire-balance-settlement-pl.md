...
api_id: "/uapi/domestic-futureoption/v1/trading/inquire-balance-settlement-pl"
api_name: "선물옵션 잔고정산손익내역"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내선물옵션] 주문/계좌 |
| API path | `/uapi/domestic-futureoption/v1/trading/inquire-balance-settlement-pl` |
| 샘플 TR ID | CTFO6117R |
| 공식 샘플 파일 | examples_llm/domestic_futureoption/inquire_balance_settlement_pl/inquire_balance_settlement_pl.py |
