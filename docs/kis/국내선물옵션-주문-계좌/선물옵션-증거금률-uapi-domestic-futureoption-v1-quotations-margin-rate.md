...
api_id: "/uapi/domestic-futureoption/v1/quotations/margin-rate"
api_name: "선물옵션 증거금률"
method: "GET"
...
# 선물옵션 증거금률 (/uapi/domestic-futureoption/v1/quotations/margin-rate)
...
| --- | --- |
| 카테고리 | [국내선물옵션] 주문/계좌 |
| API path | `/uapi/domestic-futureoption/v1/quotations/margin-rate` |
| 샘플 TR ID | - |
| 공식 샘플 파일 | - |
