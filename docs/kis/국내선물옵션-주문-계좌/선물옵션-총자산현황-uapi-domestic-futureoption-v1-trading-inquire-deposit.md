...
api_id: "/uapi/domestic-futureoption/v1/trading/inquire-deposit"
api_name: "선물옵션 총자산현황"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내선물옵션] 주문/계좌 |
| API path | `/uapi/domestic-futureoption/v1/trading/inquire-deposit` |
| 샘플 TR ID | CTRP6550R |
| 공식 샘플 파일 | examples_llm/domestic_futureoption/inquire_deposit/inquire_deposit.py |
