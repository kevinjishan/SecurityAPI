...
api_id: "/uapi/domestic-futureoption/v1/trading/inquire-ccnl-bstime"
api_name: "선물옵션 기준일체결내역"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내선물옵션] 주문/계좌 |
| API path | `/uapi/domestic-futureoption/v1/trading/inquire-ccnl-bstime` |
| 샘플 TR ID | CTFO5139R |
| 공식 샘플 파일 | examples_llm/domestic_futureoption/inquire_ccnl_bstime/inquire_ccnl_bstime.py |
...
| Query/Body | `ORD_DT` | Y |
| Query/Body | `FUOP_TR_STRT_TMD` | Y |
| Query/Body | `FUOP_TR_END_TMD` | Y |
