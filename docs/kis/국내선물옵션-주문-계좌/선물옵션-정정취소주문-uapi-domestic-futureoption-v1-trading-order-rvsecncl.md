...
api_id: "/uapi/domestic-futureoption/v1/trading/order-rvsecncl"
api_name: "선물옵션 정정취소주문"
method: "POST"
...
| --- | --- |
| 카테고리 | [국내선물옵션] 주문/계좌 |
| API path | `/uapi/domestic-futureoption/v1/trading/order-rvsecncl` |
| 샘플 TR ID | TTTO1103U, TTTN1103U, VTTO1103U |
| 공식 샘플 파일 | examples_llm/domestic_futureoption/order_rvsecncl/order_rvsecncl.py |
...
| Header | `tr_id` | TTTO1103U, TTTN1103U, VTTO1103U | Y |
