...
api_id: "/uapi/domestic-futureoption/v1/trading/inquire-daily-amount-fee"
api_name: "선물옵션기간약정수수료일별"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내선물옵션] 주문/계좌 |
| API path | `/uapi/domestic-futureoption/v1/trading/inquire-daily-amount-fee` |
| 샘플 TR ID | CTFO6119R |
| 공식 샘플 파일 | examples_llm/domestic_futureoption/inquire_daily_amount_fee/inquire_daily_amount_fee.py |
...
| Query/Body | `INQR_STRT_DAY` | Y |
| Query/Body | `INQR_END_DAY` | Y |
