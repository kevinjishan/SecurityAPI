...
api_id: "/uapi/domestic-futureoption/v1/trading/inquire-ccnl"
api_name: "선물옵션 주문체결내역조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내선물옵션] 주문/계좌 |
| API path | `/uapi/domestic-futureoption/v1/trading/inquire-ccnl` |
| 샘플 TR ID | TTTO5201R, VTTO5201R |
| 공식 샘플 파일 | examples_llm/domestic_futureoption/inquire_ccnl/inquire_ccnl.py |
...
| Header | `tr_id` | TTTO5201R, VTTO5201R | Y |
