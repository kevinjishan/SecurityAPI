...
api_id: "/uapi/domestic-futureoption/v1/trading/inquire-ngt-ccnl"
api_name: "(야간)선물옵션 주문체결 내역조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내선물옵션] 주문/계좌 |
| API path | `/uapi/domestic-futureoption/v1/trading/inquire-ngt-ccnl` |
| 샘플 TR ID | STTN5201R |
| 공식 샘플 파일 | examples_llm/domestic_futureoption/inquire_ngt_ccnl/inquire_ngt_ccnl.py |
...
| Query/Body | `STRT_ORD_DT` | Y |
| Query/Body | `END_ORD_DT` | Y |
| Query/Body | `SLL_BUY_DVSN_CD` | Y |
| Query/Body | `CCLD_NCCS_DVSN` | Y |
| Query/Body | `SORT_SQN` | Y |
| Query/Body | `STRT_ODNO` | Y |
| Query/Body | `PDNO` | Y |
| Query/Body | `MKET_ID_CD` | Y |
| Query/Body | `FUOP_DVSN_CD` | Y |
| Query/Body | `SCRN_DVSN` | Y |
