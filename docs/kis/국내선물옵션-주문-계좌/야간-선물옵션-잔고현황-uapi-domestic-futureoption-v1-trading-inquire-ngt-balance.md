...
api_id: "/uapi/domestic-futureoption/v1/trading/inquire-ngt-balance"
api_name: "(야간)선물옵션 잔고현황"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내선물옵션] 주문/계좌 |
| API path | `/uapi/domestic-futureoption/v1/trading/inquire-ngt-balance` |
| 샘플 TR ID | CTFN6118R |
| 공식 샘플 파일 | examples_llm/domestic_futureoption/inquire_ngt_balance/inquire_ngt_balance.py |
