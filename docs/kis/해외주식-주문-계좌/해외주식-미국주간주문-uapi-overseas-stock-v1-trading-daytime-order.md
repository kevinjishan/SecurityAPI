...
category: "[해외주식] 주문/계좌"
api_id: "/uapi/overseas-stock/v1/trading/daytime-order"
api_name: "해외주식 미국주간주문"
method: "POST"
...
| --- | --- |
| 카테고리 | [해외주식] 주문/계좌 |
| API path | `/uapi/overseas-stock/v1/trading/daytime-order` |
| 샘플 TR ID | TTTS6036U, TTTS6037U |
| 공식 샘플 파일 | examples_llm/overseas_stock/daytime_order/daytime_order.py |
...
| Header | `tr_id` | TTTS6036U, TTTS6037U | Y |
