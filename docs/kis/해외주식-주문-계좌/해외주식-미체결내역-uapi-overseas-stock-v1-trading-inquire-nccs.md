...
category: "[해외주식] 주문/계좌"
api_id: "/uapi/overseas-stock/v1/trading/inquire-nccs"
api_name: "해외주식 미체결내역"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 주문/계좌 |
| API path | `/uapi/overseas-stock/v1/trading/inquire-nccs` |
| 샘플 TR ID | TTTS3018R |
| 공식 샘플 파일 | examples_llm/overseas_stock/inquire_nccs/inquire_nccs.py |
