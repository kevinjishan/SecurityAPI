...
category: "[해외주식] 주문/계좌"
api_id: "/uapi/overseas-stock/v1/trading/daytime-order-rvsecncl"
api_name: "해외주식 미국주간정정취소"
method: "POST"
...
| --- | --- |
| 카테고리 | [해외주식] 주문/계좌 |
| API path | `/uapi/overseas-stock/v1/trading/daytime-order-rvsecncl` |
| 샘플 TR ID | TTTS6038U |
| 공식 샘플 파일 | examples_llm/overseas_stock/daytime_order_rvsecncl/daytime_order_rvsecncl.py |
