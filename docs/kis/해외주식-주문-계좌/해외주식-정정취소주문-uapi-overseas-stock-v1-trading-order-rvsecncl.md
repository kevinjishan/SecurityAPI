...
category: "[해외주식] 주문/계좌"
api_id: "/uapi/overseas-stock/v1/trading/order-rvsecncl"
api_name: "해외주식 정정취소주문"
method: "POST"
...
| --- | --- |
| 카테고리 | [해외주식] 주문/계좌 |
| API path | `/uapi/overseas-stock/v1/trading/order-rvsecncl` |
| 샘플 TR ID | TTTT1004U, VTTT1004U |
| 공식 샘플 파일 | examples_llm/overseas_stock/order_rvsecncl/order_rvsecncl.py |
...
| Header | `tr_id` | TTTT1004U, VTTT1004U | Y |
