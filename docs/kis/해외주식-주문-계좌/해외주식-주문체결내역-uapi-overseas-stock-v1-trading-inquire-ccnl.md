...
category: "[해외주식] 주문/계좌"
api_id: "/uapi/overseas-stock/v1/trading/inquire-ccnl"
api_name: "해외주식 주문체결내역"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 주문/계좌 |
| API path | `/uapi/overseas-stock/v1/trading/inquire-ccnl` |
| 샘플 TR ID | TTTS3035R, VTTS3035R |
| 공식 샘플 파일 | examples_llm/overseas_stock/inquire_ccnl/inquire_ccnl.py |
...
| Header | `tr_id` | TTTS3035R, VTTS3035R | Y |
...
| Query/Body | `PDNO` | Y |
| Query/Body | `ORD_STRT_DT` | Y |
| Query/Body | `ORD_END_DT` | Y |
| Query/Body | `SLL_BUY_DVSN` | Y |
