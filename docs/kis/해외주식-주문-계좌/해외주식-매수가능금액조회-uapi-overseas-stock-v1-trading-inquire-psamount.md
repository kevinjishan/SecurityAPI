...
category: "[해외주식] 주문/계좌"
api_id: "/uapi/overseas-stock/v1/trading/inquire-psamount"
api_name: "해외주식 매수가능금액조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 주문/계좌 |
| API path | `/uapi/overseas-stock/v1/trading/inquire-psamount` |
| 샘플 TR ID | TTTS3007R, VTTS3007R |
| 공식 샘플 파일 | examples_llm/overseas_stock/inquire_psamount/inquire_psamount.py |
...
| Header | `tr_id` | TTTS3007R, VTTS3007R | Y |
