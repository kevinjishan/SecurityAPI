...
category: "[해외주식] 주문/계좌"
api_id: "/uapi/overseas-stock/v1/trading/order-resv-list"
api_name: "해외주식 예약주문조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 주문/계좌 |
| API path | `/uapi/overseas-stock/v1/trading/order-resv-list` |
| 샘플 TR ID | TTTT3039R, TTTS3014R |
| 공식 샘플 파일 | examples_llm/overseas_stock/order_resv_list/order_resv_list.py |
...
| Header | `tr_id` | TTTT3039R, TTTS3014R | Y |
