...
category: "[해외주식] 주문/계좌"
api_id: "/uapi/overseas-stock/v1/trading/inquire-balance"
api_name: "해외주식 잔고"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 주문/계좌 |
| API path | `/uapi/overseas-stock/v1/trading/inquire-balance` |
| 샘플 TR ID | TTTS3012R, VTTS3012R |
| 공식 샘플 파일 | examples_llm/overseas_stock/inquire_balance/inquire_balance.py |
...
| Header | `tr_id` | TTTS3012R, VTTS3012R | Y |
