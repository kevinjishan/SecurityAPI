...
category: "[해외주식] 주문/계좌"
api_id: "/uapi/overseas-stock/v1/trading/algo-ordno"
api_name: "해외주식 지정가주문번호조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 주문/계좌 |
| API path | `/uapi/overseas-stock/v1/trading/algo-ordno` |
| 샘플 TR ID | TTTS6058R |
| 공식 샘플 파일 | examples_llm/overseas_stock/algo_ordno/algo_ordno.py |
