...
category: "[해외주식] 주문/계좌"
api_id: "/uapi/overseas-stock/v1/trading/foreign-margin"
api_name: "해외증거금 통화별조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 주문/계좌 |
| API path | `/uapi/overseas-stock/v1/trading/foreign-margin` |
| 샘플 TR ID | TTTC2101R |
| 공식 샘플 파일 | examples_llm/overseas_stock/foreign_margin/foreign_margin.py |
