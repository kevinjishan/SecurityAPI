...
category: "[해외주식] 주문/계좌"
api_id: "/uapi/overseas-stock/v1/trading/inquire-algo-ccnl"
api_name: "해외주식 지정가체결내역조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 주문/계좌 |
| API path | `/uapi/overseas-stock/v1/trading/inquire-algo-ccnl` |
| 샘플 TR ID | TTTS6059R |
| 공식 샘플 파일 | examples_llm/overseas_stock/inquire_algo_ccnl/inquire_algo_ccnl.py |
