...
category: "[해외주식] 주문/계좌"
api_id: "/uapi/overseas-stock/v1/trading/inquire-period-profit"
api_name: "해외주식 기간손익"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 주문/계좌 |
| API path | `/uapi/overseas-stock/v1/trading/inquire-period-profit` |
| 샘플 TR ID | TTTS3039R |
| 공식 샘플 파일 | examples_llm/overseas_stock/inquire_period_profit/inquire_period_profit.py |
