...
category: "[해외주식] 주문/계좌"
api_id: "/uapi/overseas-stock/v1/trading/inquire-period-trans"
api_name: "해외주식 일별거래내역"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 주문/계좌 |
| API path | `/uapi/overseas-stock/v1/trading/inquire-period-trans` |
| 샘플 TR ID | CTOS4001R |
| 공식 샘플 파일 | examples_llm/overseas_stock/inquire_period_trans/inquire_period_trans.py |
...
| Query/Body | `ERLM_STRT_DT` | Y |
| Query/Body | `ERLM_END_DT` | Y |
| Query/Body | `OVRS_EXCG_CD` | Y |
| Query/Body | `PDNO` | Y |
| Query/Body | `SLL_BUY_DVSN_CD` | Y |
| Query/Body | `LOAN_DVSN_CD` | Y |
