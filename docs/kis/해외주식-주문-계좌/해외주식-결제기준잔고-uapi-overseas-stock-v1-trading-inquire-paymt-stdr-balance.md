...
category: "[해외주식] 주문/계좌"
api_id: "/uapi/overseas-stock/v1/trading/inquire-paymt-stdr-balance"
api_name: "해외주식 결제기준잔고"
method: "GET"
...
| --- | --- |
| 카테고리 | [해외주식] 주문/계좌 |
| API path | `/uapi/overseas-stock/v1/trading/inquire-paymt-stdr-balance` |
| 샘플 TR ID | CTRP6010R |
| 공식 샘플 파일 | examples_llm/overseas_stock/inquire_paymt_stdr_balance/inquire_paymt_stdr_balance.py |
