...
category: "[국내주식] 주문/계좌"
api_id: "/uapi/domestic-stock/v1/trading/inquire-credit-psamount"
api_name: "신용매수가능조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 주문/계좌 |
| API path | `/uapi/domestic-stock/v1/trading/inquire-credit-psamount` |
| 샘플 TR ID | TTTC8909R |
| 공식 샘플 파일 | examples_llm/domestic_stock/inquire_credit_psamount/inquire_credit_psamount.py |
