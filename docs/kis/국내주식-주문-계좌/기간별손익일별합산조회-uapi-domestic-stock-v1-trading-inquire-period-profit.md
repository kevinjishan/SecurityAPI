...
category: "[국내주식] 주문/계좌"
api_id: "/uapi/domestic-stock/v1/trading/inquire-period-profit"
api_name: "기간별손익일별합산조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 주문/계좌 |
| API path | `/uapi/domestic-stock/v1/trading/inquire-period-profit` |
| 샘플 TR ID | TTTC8708R |
| 공식 샘플 파일 | examples_llm/domestic_stock/inquire_period_profit/inquire_period_profit.py |
