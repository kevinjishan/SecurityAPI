...
category: "[국내주식] 주문/계좌"
api_id: "/uapi/domestic-stock/v1/trading/pension/inquire-psbl-order"
api_name: "퇴직연금 매수가능조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 주문/계좌 |
| API path | `/uapi/domestic-stock/v1/trading/pension/inquire-psbl-order` |
| 샘플 TR ID | TTTC0503R |
| 공식 샘플 파일 | examples_llm/domestic_stock/pension_inquire_psbl_order/pension_inquire_psbl_order.py |
...
| Query/Body | `PDNO` | Y |
| Query/Body | `ACCA_DVSN_CD` | Y |
| Query/Body | `CMA_EVLU_AMT_ICLD_YN` | Y |
