...
category: "[국내주식] 주문/계좌"
api_id: "/uapi/domestic-stock/v1/trading/order-resv-ccnl"
api_name: "주식예약주문조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 주문/계좌 |
| API path | `/uapi/domestic-stock/v1/trading/order-resv-ccnl` |
| 샘플 TR ID | CTSC0004R |
| 공식 샘플 파일 | examples_llm/domestic_stock/order_resv_ccnl/order_resv_ccnl.py |
...
| Query/Body | `TMNL_MDIA_KIND_CD` | Y |
| Query/Body | `CANO` | Y |
| Query/Body | `ACNT_PRDT_CD` | Y |
| Query/Body | `PRCS_DVSN_CD` | Y |
| Query/Body | `CNCL_YN` | Y |
