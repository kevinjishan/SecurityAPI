...
category: "[국내주식] 주문/계좌"
api_id: "/uapi/domestic-stock/v1/trading/inquire-balance"
api_name: "주식잔고조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 주문/계좌 |
| API path | `/uapi/domestic-stock/v1/trading/inquire-balance` |
| 샘플 TR ID | TTTC8434R, VTTC8434R |
| 공식 샘플 파일 | examples_llm/domestic_stock/inquire_balance/inquire_balance.py |
...
| Header | `tr_id` | TTTC8434R, VTTC8434R | Y |
