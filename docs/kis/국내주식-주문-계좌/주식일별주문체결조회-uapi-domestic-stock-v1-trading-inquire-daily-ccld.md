...
category: "[국내주식] 주문/계좌"
api_id: "/uapi/domestic-stock/v1/trading/inquire-daily-ccld"
api_name: "주식일별주문체결조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 주문/계좌 |
| API path | `/uapi/domestic-stock/v1/trading/inquire-daily-ccld` |
| 샘플 TR ID | CTSC9215R, TTTC0081R, VTSC9215R, VTTC0081R |
| 공식 샘플 파일 | examples_llm/domestic_stock/inquire_daily_ccld/inquire_daily_ccld.py |
...
| Header | `tr_id` | CTSC9215R, TTTC0081R, VTSC9215R, VTTC0081R | Y |
...
| Query/Body | `PDNO` | Y |
| Query/Body | `CCLD_DVSN` | Y |
| Query/Body | `INQR_DVSN` | Y |
| Query/Body | `INQR_DVSN_3` | Y |
| Query/Body | `ORD_GNO_BRNO` | Y |
| Query/Body | `ODNO` | Y |
| Query/Body | `INQR_DVSN_1` | Y |
