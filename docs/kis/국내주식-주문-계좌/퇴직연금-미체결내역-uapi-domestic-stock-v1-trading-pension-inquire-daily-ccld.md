...
category: "[국내주식] 주문/계좌"
api_id: "/uapi/domestic-stock/v1/trading/pension/inquire-daily-ccld"
api_name: "퇴직연금 미체결내역"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 주문/계좌 |
| API path | `/uapi/domestic-stock/v1/trading/pension/inquire-daily-ccld` |
| 샘플 TR ID | TTTC2201R |
| 공식 샘플 파일 | examples_llm/domestic_stock/pension_inquire_daily_ccld/pension_inquire_daily_ccld.py |
