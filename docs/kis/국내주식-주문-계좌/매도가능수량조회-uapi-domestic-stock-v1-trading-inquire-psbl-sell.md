...
category: "[국내주식] 주문/계좌"
api_id: "/uapi/domestic-stock/v1/trading/inquire-psbl-sell"
api_name: "매도가능수량조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 주문/계좌 |
| API path | `/uapi/domestic-stock/v1/trading/inquire-psbl-sell` |
| 샘플 TR ID | TTTC8408R |
| 공식 샘플 파일 | examples_llm/domestic_stock/inquire_psbl_sell/inquire_psbl_sell.py |
