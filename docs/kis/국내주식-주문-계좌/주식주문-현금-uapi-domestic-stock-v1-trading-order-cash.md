...
category: "[국내주식] 주문/계좌"
api_id: "/uapi/domestic-stock/v1/trading/order-cash"
api_name: "주식주문(현금)"
method: "POST"
...
| --- | --- |
| 카테고리 | [국내주식] 주문/계좌 |
| API path | `/uapi/domestic-stock/v1/trading/order-cash` |
| 샘플 TR ID | TTTC0011U, TTTC0012U, VTTC0011U, VTTC0012U |
| 공식 샘플 파일 | examples_llm/domestic_stock/order_cash/order_cash.py |
...
| Header | `tr_id` | TTTC0011U, TTTC0012U, VTTC0011U, VTTC0012U | Y |
