...
category: "[국내주식] 주문/계좌"
api_id: "/uapi/domestic-stock/v1/trading/intgr-margin"
api_name: "주식통합증거금 현황"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 주문/계좌 |
| API path | `/uapi/domestic-stock/v1/trading/intgr-margin` |
| 샘플 TR ID | TTTC0869R |
| 공식 샘플 파일 | examples_llm/domestic_stock/intgr_margin/intgr_margin.py |
...
| Query/Body | `FWEX_CTRT_FRCR_DVSN_CD` | Y |
