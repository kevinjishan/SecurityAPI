...
category: "[국내주식] 주문/계좌"
api_id: "/uapi/domestic-stock/v1/trading/inquire-account-balance"
api_name: "투자계좌자산현황조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 주문/계좌 |
| API path | `/uapi/domestic-stock/v1/trading/inquire-account-balance` |
| 샘플 TR ID | CTRP6548R |
| 공식 샘플 파일 | examples_llm/domestic_stock/inquire_account_balance/inquire_account_balance.py |
...
| Query/Body | `BSPR_BF_DT_APLY_YN` | Y |
