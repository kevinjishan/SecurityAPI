...
category: "[국내주식] 주문/계좌"
api_id: "/uapi/domestic-stock/v1/trading/pension/inquire-deposit"
api_name: "퇴직연금 예수금조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 주문/계좌 |
| API path | `/uapi/domestic-stock/v1/trading/pension/inquire-deposit` |
| 샘플 TR ID | TTTC0506R |
| 공식 샘플 파일 | examples_llm/domestic_stock/pension_inquire_deposit/pension_inquire_deposit.py |
