...
category: "[국내주식] 주문/계좌"
api_id: "/uapi/domestic-stock/v1/trading/pension/inquire-present-balance"
api_name: "퇴직연금 체결기준잔고"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 주문/계좌 |
| API path | `/uapi/domestic-stock/v1/trading/pension/inquire-present-balance` |
| 샘플 TR ID | TTTC2202R |
| 공식 샘플 파일 | examples_llm/domestic_stock/pension_inquire_present_balance/pension_inquire_present_balance.py |
