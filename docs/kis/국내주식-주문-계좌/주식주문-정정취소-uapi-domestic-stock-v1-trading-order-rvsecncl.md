...
category: "[국내주식] 주문/계좌"
api_id: "/uapi/domestic-stock/v1/trading/order-rvsecncl"
api_name: "주식주문(정정취소)"
method: "POST"
...
| --- | --- |
| 카테고리 | [국내주식] 주문/계좌 |
| API path | `/uapi/domestic-stock/v1/trading/order-rvsecncl` |
| 샘플 TR ID | TTTC0013U, VTTC0013U |
| 공식 샘플 파일 | examples_llm/domestic_stock/order_rvsecncl/order_rvsecncl.py |
...
| Header | `tr_id` | TTTC0013U, VTTC0013U | Y |
