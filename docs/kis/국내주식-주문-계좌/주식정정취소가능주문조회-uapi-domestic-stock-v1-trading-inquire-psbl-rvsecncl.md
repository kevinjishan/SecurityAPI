...
category: "[국내주식] 주문/계좌"
api_id: "/uapi/domestic-stock/v1/trading/inquire-psbl-rvsecncl"
api_name: "주식정정취소가능주문조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 주문/계좌 |
| API path | `/uapi/domestic-stock/v1/trading/inquire-psbl-rvsecncl` |
| 샘플 TR ID | TTTC0084R |
| 공식 샘플 파일 | examples_llm/domestic_stock/inquire_psbl_rvsecncl/inquire_psbl_rvsecncl.py |
