...
category: "[국내주식] 주문/계좌"
api_id: "/uapi/domestic-stock/v1/trading/inquire-psbl-order"
api_name: "매수가능조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 주문/계좌 |
| API path | `/uapi/domestic-stock/v1/trading/inquire-psbl-order` |
| 샘플 TR ID | TTTC8908R, VTTC8908R |
| 공식 샘플 파일 | examples_llm/domestic_stock/inquire_psbl_order/inquire_psbl_order.py |
...
| Header | `tr_id` | TTTC8908R, VTTC8908R | Y |
