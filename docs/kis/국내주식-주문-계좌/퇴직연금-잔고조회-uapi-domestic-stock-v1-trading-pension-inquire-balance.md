...
category: "[국내주식] 주문/계좌"
api_id: "/uapi/domestic-stock/v1/trading/pension/inquire-balance"
api_name: "퇴직연금 잔고조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 주문/계좌 |
| API path | `/uapi/domestic-stock/v1/trading/pension/inquire-balance` |
| 샘플 TR ID | TTTC2208R |
| 공식 샘플 파일 | examples_llm/domestic_stock/pension_inquire_balance/pension_inquire_balance.py |
