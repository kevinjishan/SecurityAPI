...
category: "[장내채권] 기본시세"
api_id: "/uapi/domestic-bond/v1/quotations/inquire-daily-price"
api_name: "장내채권현재가(일별)"
method: "GET"
...
| --- | --- |
| 카테고리 | [장내채권] 기본시세 |
| API path | `/uapi/domestic-bond/v1/quotations/inquire-daily-price` |
| 샘플 TR ID | FHKBJ773404C0 |
| 공식 샘플 파일 | examples_llm/domestic_bond/inquire_daily_price/inquire_daily_price.py |
