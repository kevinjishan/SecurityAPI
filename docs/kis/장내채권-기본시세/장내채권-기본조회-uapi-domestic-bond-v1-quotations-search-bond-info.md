...
category: "[장내채권] 기본시세"
api_id: "/uapi/domestic-bond/v1/quotations/search-bond-info"
api_name: "장내채권 기본조회"
method: "GET"
...
| --- | --- |
| 카테고리 | [장내채권] 기본시세 |
| API path | `/uapi/domestic-bond/v1/quotations/search-bond-info` |
| 샘플 TR ID | CTPF1114R |
| 공식 샘플 파일 | examples_llm/domestic_bond/search_bond_info/search_bond_info.py |
