...
category: "[장내채권] 기본시세"
api_id: "/uapi/domestic-bond/v1/quotations/inquire-daily-itemchartprice"
api_name: "장내채권 기간별시세(일)"
method: "GET"
...
| --- | --- |
| 카테고리 | [장내채권] 기본시세 |
| API path | `/uapi/domestic-bond/v1/quotations/inquire-daily-itemchartprice` |
| 샘플 TR ID | FHKBJ773701C0 |
| 공식 샘플 파일 | examples_llm/domestic_bond/inquire_daily_itemchartprice/inquire_daily_itemchartprice.py |
