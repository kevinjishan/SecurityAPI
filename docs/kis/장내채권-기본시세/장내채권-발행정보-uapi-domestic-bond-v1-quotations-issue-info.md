...
category: "[장내채권] 기본시세"
api_id: "/uapi/domestic-bond/v1/quotations/issue-info"
api_name: "장내채권 발행정보"
method: "GET"
...
| --- | --- |
| 카테고리 | [장내채권] 기본시세 |
| API path | `/uapi/domestic-bond/v1/quotations/issue-info` |
| 샘플 TR ID | CTPF1101R |
| 공식 샘플 파일 | examples_llm/domestic_bond/issue_info/issue_info.py |
