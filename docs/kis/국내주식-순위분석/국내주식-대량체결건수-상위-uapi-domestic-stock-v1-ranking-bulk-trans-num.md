...
category: "[국내주식] 순위분석"
api_id: "/uapi/domestic-stock/v1/ranking/bulk-trans-num"
api_name: "국내주식 대량체결건수 상위"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 순위분석 |
| API path | `/uapi/domestic-stock/v1/ranking/bulk-trans-num` |
| 샘플 TR ID | FHKST190900C0 |
| 공식 샘플 파일 | examples_llm/domestic_stock/bulk_trans_num/bulk_trans_num.py |
