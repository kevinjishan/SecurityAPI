...
category: "[국내주식] 순위분석"
api_id: "/uapi/domestic-stock/v1/ranking/near-new-highlow"
api_name: "국내주식 신고/신저근접종목 상위"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 순위분석 |
| API path | `/uapi/domestic-stock/v1/ranking/near-new-highlow` |
| 샘플 TR ID | FHPST01870000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/near_new_highlow/near_new_highlow.py |
