...
category: "[국내주식] 순위분석"
api_id: "/uapi/domestic-stock/v1/ranking/prefer-disparate-ratio"
api_name: "국내주식 우선주/괴리율 상위"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 순위분석 |
| API path | `/uapi/domestic-stock/v1/ranking/prefer-disparate-ratio` |
| 샘플 TR ID | FHPST01770000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/prefer_disparate_ratio/prefer_disparate_ratio.py |
