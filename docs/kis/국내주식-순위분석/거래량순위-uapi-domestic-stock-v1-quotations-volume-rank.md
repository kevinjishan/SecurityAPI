...
category: "[국내주식] 순위분석"
api_id: "/uapi/domestic-stock/v1/quotations/volume-rank"
api_name: "거래량순위"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 순위분석 |
| API path | `/uapi/domestic-stock/v1/quotations/volume-rank` |
| 샘플 TR ID | FHPST01710000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/volume_rank/volume_rank.py |
