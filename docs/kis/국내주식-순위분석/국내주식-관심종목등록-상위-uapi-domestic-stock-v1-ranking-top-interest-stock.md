...
category: "[국내주식] 순위분석"
api_id: "/uapi/domestic-stock/v1/ranking/top-interest-stock"
api_name: "국내주식 관심종목등록 상위"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 순위분석 |
| API path | `/uapi/domestic-stock/v1/ranking/top-interest-stock` |
| 샘플 TR ID | FHPST01800000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/top_interest_stock/top_interest_stock.py |
