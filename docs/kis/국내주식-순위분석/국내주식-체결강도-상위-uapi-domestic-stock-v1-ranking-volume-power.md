...
category: "[국내주식] 순위분석"
api_id: "/uapi/domestic-stock/v1/ranking/volume-power"
api_name: "국내주식 체결강도 상위"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 순위분석 |
| API path | `/uapi/domestic-stock/v1/ranking/volume-power` |
| 샘플 TR ID | FHPST01680000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/volume_power/volume_power.py |
