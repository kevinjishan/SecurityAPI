...
category: "[국내주식] 순위분석"
api_id: "/uapi/domestic-stock/v1/ranking/hts-top-view"
api_name: "HTS조회상위20종목"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 순위분석 |
| API path | `/uapi/domestic-stock/v1/ranking/hts-top-view` |
| 샘플 TR ID | HHMCM000100C0 |
| 공식 샘플 파일 | examples_llm/domestic_stock/hts_top_view/hts_top_view.py |
