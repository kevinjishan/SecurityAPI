...
category: "[국내주식] 순위분석"
api_id: "/uapi/domestic-stock/v1/ranking/exp-trans-updown"
api_name: "국내주식 예상체결 상승/하락상위"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 순위분석 |
| API path | `/uapi/domestic-stock/v1/ranking/exp-trans-updown` |
| 샘플 TR ID | FHPST01820000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/exp_trans_updown/exp_trans_updown.py |
