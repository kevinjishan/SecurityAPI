...
category: "[국내주식] 순위분석"
api_id: "/uapi/domestic-stock/v1/ranking/disparity"
api_name: "국내주식 이격도 순위"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 순위분석 |
| API path | `/uapi/domestic-stock/v1/ranking/disparity` |
| 샘플 TR ID | FHPST01780000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/disparity/disparity.py |
