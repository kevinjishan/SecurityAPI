...
category: "[국내주식] 순위분석"
api_id: "/uapi/domestic-stock/v1/ranking/credit-balance"
api_name: "국내주식 신용잔고 상위"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 순위분석 |
| API path | `/uapi/domestic-stock/v1/ranking/credit-balance` |
| 샘플 TR ID | FHKST17010000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/credit_balance/credit_balance.py |
