...
category: "[국내주식] 순위분석"
api_id: "/uapi/domestic-stock/v1/ranking/after-hour-balance"
api_name: "국내주식 시간외잔량 순위"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 순위분석 |
| API path | `/uapi/domestic-stock/v1/ranking/after-hour-balance` |
| 샘플 TR ID | FHPST01760000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/after_hour_balance/after_hour_balance.py |
