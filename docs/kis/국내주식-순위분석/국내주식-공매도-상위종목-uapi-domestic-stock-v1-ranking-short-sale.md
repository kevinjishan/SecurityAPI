...
category: "[국내주식] 순위분석"
api_id: "/uapi/domestic-stock/v1/ranking/short-sale"
api_name: "국내주식 공매도 상위종목"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 순위분석 |
| API path | `/uapi/domestic-stock/v1/ranking/short-sale` |
| 샘플 TR ID | FHPST04820000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/short_sale/short_sale.py |
...
| 위치 | 필드 | 필수 |
| --- | --- | --- |
| Query/Body | `FID_APLY_RANG_VOL` | Y |
