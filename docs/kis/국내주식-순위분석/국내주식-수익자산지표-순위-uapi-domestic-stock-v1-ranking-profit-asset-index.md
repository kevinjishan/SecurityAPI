...
category: "[국내주식] 순위분석"
api_id: "/uapi/domestic-stock/v1/ranking/profit-asset-index"
api_name: "국내주식 수익자산지표 순위"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 순위분석 |
| API path | `/uapi/domestic-stock/v1/ranking/profit-asset-index` |
| 샘플 TR ID | FHPST01730000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/profit_asset_index/profit_asset_index.py |
