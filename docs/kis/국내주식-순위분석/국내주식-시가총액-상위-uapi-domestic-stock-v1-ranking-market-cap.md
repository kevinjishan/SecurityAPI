...
category: "[국내주식] 순위분석"
api_id: "/uapi/domestic-stock/v1/ranking/market-cap"
api_name: "국내주식 시가총액 상위"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 순위분석 |
| API path | `/uapi/domestic-stock/v1/ranking/market-cap` |
| 샘플 TR ID | FHPST01740000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/market_cap/market_cap.py |
