...
category: "[국내주식] 순위분석"
api_id: "/uapi/domestic-stock/v1/ranking/traded-by-company"
api_name: "국내주식 당사매매종목 상위"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 순위분석 |
| API path | `/uapi/domestic-stock/v1/ranking/traded-by-company` |
| 샘플 TR ID | FHPST01860000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/traded_by_company/traded_by_company.py |
