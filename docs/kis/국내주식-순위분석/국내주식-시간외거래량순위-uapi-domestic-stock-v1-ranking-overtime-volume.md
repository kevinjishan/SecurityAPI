...
category: "[국내주식] 순위분석"
api_id: "/uapi/domestic-stock/v1/ranking/overtime-volume"
api_name: "국내주식 시간외거래량순위"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내주식] 순위분석 |
| API path | `/uapi/domestic-stock/v1/ranking/overtime-volume` |
| 샘플 TR ID | FHPST02350000 |
| 공식 샘플 파일 | examples_llm/domestic_stock/overtime_volume/overtime_volume.py |
