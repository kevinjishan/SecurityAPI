...
api_id: "/uapi/domestic-futureoption/v1/quotations/display-board-top"
api_name: "국내선물 기초자산 시세"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내선물옵션] 기본시세 |
| API path | `/uapi/domestic-futureoption/v1/quotations/display-board-top` |
| 샘플 TR ID | FHPIF05030000 |
| 공식 샘플 파일 | examples_llm/domestic_futureoption/display_board_top/display_board_top.py |
