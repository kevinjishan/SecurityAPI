...
api_id: "/uapi/domestic-futureoption/v1/quotations/inquire-price"
api_name: "선물옵션 시세"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내선물옵션] 기본시세 |
| API path | `/uapi/domestic-futureoption/v1/quotations/inquire-price` |
| 샘플 TR ID | FHMIF10000000 |
| 공식 샘플 파일 | examples_llm/domestic_futureoption/inquire_price/inquire_price.py |
