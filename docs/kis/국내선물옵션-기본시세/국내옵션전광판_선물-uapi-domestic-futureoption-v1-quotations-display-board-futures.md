...
api_id: "/uapi/domestic-futureoption/v1/quotations/display-board-futures"
api_name: "국내옵션전광판_선물"
method: "GET"
...
# 국내옵션전광판_선물 (/uapi/domestic-futureoption/v1/quotations/display-board-futures)
...
| --- | --- |
| 카테고리 | [국내선물옵션] 기본시세 |
| API path | `/uapi/domestic-futureoption/v1/quotations/display-board-futures` |
| 샘플 TR ID | FHPIF05030200 |
| 공식 샘플 파일 | examples_llm/domestic_futureoption/display_board_futures/display_board_futures.py |
