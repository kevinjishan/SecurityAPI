...
api_id: "/uapi/domestic-futureoption/v1/quotations/exp-price-trend"
api_name: "선물옵션 일중예상체결추이"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내선물옵션] 기본시세 |
| API path | `/uapi/domestic-futureoption/v1/quotations/exp-price-trend` |
| 샘플 TR ID | FHPIF05110100 |
| 공식 샘플 파일 | examples_llm/domestic_futureoption/exp_price_trend/exp_price_trend.py |
