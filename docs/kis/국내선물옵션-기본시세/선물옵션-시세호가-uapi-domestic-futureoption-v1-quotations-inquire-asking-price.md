...
api_id: "/uapi/domestic-futureoption/v1/quotations/inquire-asking-price"
api_name: "선물옵션 시세호가"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내선물옵션] 기본시세 |
| API path | `/uapi/domestic-futureoption/v1/quotations/inquire-asking-price` |
| 샘플 TR ID | FHMIF10010000 |
| 공식 샘플 파일 | examples_llm/domestic_futureoption/inquire_asking_price/inquire_asking_price.py |
