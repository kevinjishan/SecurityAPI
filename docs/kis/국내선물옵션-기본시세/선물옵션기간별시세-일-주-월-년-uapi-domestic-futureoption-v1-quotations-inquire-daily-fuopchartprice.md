...
api_id: "/uapi/domestic-futureoption/v1/quotations/inquire-daily-fuopchartprice"
api_name: "선물옵션기간별시세(일/주/월/년)"
method: "GET"
...
| --- | --- |
| 카테고리 | [국내선물옵션] 기본시세 |
| API path | `/uapi/domestic-futureoption/v1/quotations/inquire-daily-fuopchartprice` |
| 샘플 TR ID | FHKIF03020100 |
| 공식 샘플 파일 | examples_llm/domestic_futureoption/inquire_daily_fuopchartprice/inquire_daily_fuopchartprice.py |
...
| Query/Body | `FID_PERIOD_DIV_CODE` | Y |
