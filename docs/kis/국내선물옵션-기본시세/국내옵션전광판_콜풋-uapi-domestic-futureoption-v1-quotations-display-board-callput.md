...
api_id: "/uapi/domestic-futureoption/v1/quotations/display-board-callput"
api_name: "국내옵션전광판_콜풋"
method: "GET"
...
# 국내옵션전광판_콜풋 (/uapi/domestic-futureoption/v1/quotations/display-board-callput)
...
| --- | --- |
| 카테고리 | [국내선물옵션] 기본시세 |
| API path | `/uapi/domestic-futureoption/v1/quotations/display-board-callput` |
| 샘플 TR ID | FHPIF05030100 |
| 공식 샘플 파일 | examples_llm/domestic_futureoption/display_board_callput/display_board_callput.py |
...
| Query/Body | `FID_MTRT_CNT` | Y |
| Query/Body | `FID_MRKT_CLS_CODE1` | Y |
