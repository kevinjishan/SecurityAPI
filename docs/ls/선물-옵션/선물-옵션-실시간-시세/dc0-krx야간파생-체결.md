...
tr_id: "futroptn-0000-0000-0000-000000000DC0"
tr_code: "DC0"
method: "POST"
...
| Response Body | `sbasis` | 시장BASIS | String | Y | 6.2 | - |
| Response Body | `ibasis` | 이론BASIS | String | Y | 6.2 | - |
...
| Response Body | `eqva` | KOSPI등가 | Number | Y | 7.2 | - |
| Response Body | `impv` | 내재변동성 | Number | Y | 6.2 | - |
| Response Body | `timevalue` | 시간가치 | Number | Y | 6.2 | - |
