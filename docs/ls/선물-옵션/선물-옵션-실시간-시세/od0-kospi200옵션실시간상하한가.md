...
tr_id: "yw60867c-45fb-w47r-2db4-2861e0vb5evx"
tr_code: "OD0"
method: "POST"
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Response Body | `gubun` | 접속매매여부 | String | Y | 1 | - |
| Response Body | `dy_gubun` | 실시간가격제한여부 | String | Y | 1 | - |
| Response Body | `dy_uplmtprice` | 실시간상한가 | String | Y | 8.2 | - |
| Response Body | `dy_dnlmtprice` | 실시간하한가 | String | Y | 8.2 | - |
| Response Body | `opttcode` | 단축코드 | String | Y | 8 | - |
