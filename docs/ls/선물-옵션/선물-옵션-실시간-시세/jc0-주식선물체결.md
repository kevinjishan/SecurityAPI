...
tr_id: "8zcc1f1e-58k6-n20f-ypg1-h2rd6hd3v304"
tr_code: "JC0"
method: "POST"
...
| Response Body | `sign` | 대비기호 | String | Y | 1 | - |
| Response Body | `change` | 전일대비 | String | Y | 10 | - |
| Response Body | `drate` | 등락율 | String | Y | 6.2 | - |
| Response Body | `price` | 현재가 | String | Y | 10 | - |
| Response Body | `open` | 시가 | String | Y | 10 | - |
| Response Body | `high` | 고가 | String | Y | 10 | - |
| Response Body | `low` | 저가 | String | Y | 10 | - |
| Response Body | `cgubun` | 체결구분 | String | Y | 1 | - |
| Response Body | `cvolume` | 체결량 | String | Y | 6 | - |
| Response Body | `volume` | 누적거래량 | String | Y | 12 | - |
| Response Body | `value` | 누적거래대금 | String | Y | 15 | - |
...
| Response Body | `theoryprice` | 이론가 | String | Y | 8 | - |
| Response Body | `kasis` | 괴리율 | String | Y | 6.3 | - |
| Response Body | `sbasis` | 시장BASIS | String | Y | 6 | - |
| Response Body | `ibasis` | 이론BASIS | String | Y | 6 | - |
...
| Response Body | `basprice` | 기초자산현재가 | String | Y | 8 | - |
