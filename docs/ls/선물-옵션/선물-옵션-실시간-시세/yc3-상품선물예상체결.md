...
tr_id: "e2v4f5qi-3038-420r-5pkt-pa84oh287xni"
tr_code: "YC3"
method: "POST"
...
| Response Body | `yeprice` | 예상체결가격 | String | Y | 9.2 | - |
| Response Body | `yevolume` | 예상체결수량 | String | Y | 6 | - |
| Response Body | `jnilysign` | 예상체결가전일종가대비구분 | String | Y | 1 | - |
| Response Body | `jnilchange` | 예상체결가전일종가대비 | String | Y | 9.2 | - |
| Response Body | `jnilydrate` | 예상체결가전일종가등락율 | String | Y | 9.2 | - |
