...
api_name: "[선물/옵션] 주문"
tr_id: "1g6i3v5a-4n3u-63d1-07br-ykv647gu38uf"
tr_code: "CFOAT00100"
method: "POST"
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Request Body | `CFOAT00100InBlock1` | CFOAT00100InBlock1 | Object | Y | - | - |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Response Body | `CFOAT00100OutBlock1` | CFOAT00100OutBlock1 | Object | Y | - | - |
...
| Response Body | `CFOAT00100OutBlock2` | CFOAT00100OutBlock2 | Object | Y | - | - |
| Response Body | `-RecCnt` | 레코드갯수 | Number | Y | 5 | - |
