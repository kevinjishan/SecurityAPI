...
api_name: "[선물/옵션] 주문"
tr_id: "futroptn-0000-0000-0000-00CCENT00200"
tr_code: "CCENT00200"
method: "POST"
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Request Body | `CCENT00200InBlock1` | CCENT00200InBlock1 | Object | Y | - | - |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Response Body | `CCENT00200OutBlock1` | CCENT00200OutBlock1 | Object | Y | - | - |
...
| Response Body | `CCENT00200OutBlock2` | CCENT00200OutBlock2 | Object | Y | - | - |
| Response Body | `-RecCnt` | 레코드갯수 | Number | Y | 5 | - |
