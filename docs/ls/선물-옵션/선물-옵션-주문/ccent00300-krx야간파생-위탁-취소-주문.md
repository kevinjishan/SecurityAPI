...
api_name: "[선물/옵션] 주문"
tr_id: "futroptn-0000-0000-0000-00CCENT00300"
tr_code: "CCENT00300"
method: "POST"
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Request Body | `CCENT00300InBlock1` | CCENT00300InBlock1 | Object | Y | - | - |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Response Body | `CCENT00300OutBlock1` | CCENT00300OutBlock1 | Object | Y | - | - |
...
| Response Body | `CCENT00300OutBlock2` | CCENT00300OutBlock2 | Object | Y | - | - |
| Response Body | `-RecCnt` | 레코드갯수 | Number | Y | 5 | - |
