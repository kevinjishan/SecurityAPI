...
api_name: "[선물/옵션] 계좌"
tr_id: "216z4ie2-4275-4887-3740-6i2dr3a16626"
tr_code: "CFOAQ00600"
method: "POST"
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Request Body | `CFOAQ00600InBlock1` | CFOAQ00600InBlock1 | Object | Y | - | - |
...
| Request Body | `-PrdgrpCode` | 상품군코드 | String | Y | 2 | 00:전체<br>01:주가지수<br>02:개별주식<br>03:가공채권<br>04:통화<br>05:상품<br>06:금리 |
| Request Body | `-PrdtExecTpCode` | 체결구분 | String | Y | 1 | 0:전체<br>1:체결<br>2:미체결 |
| Request Body | `-StnlnSeqTp` | 정렬순서구분 | String | Y | 1 | 3:역순<br>4:정순 |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Response Body | `CFOAQ00600OutBlock1` | CFOAQ00600OutBlock1 | Object | Y | - | - |
...
| Response Body | `CFOAQ00600OutBlock2` | CFOAQ00600OutBlock2 | Object | Y | - | - |
| Response Body | `-RecCnt` | 레코드갯수 | Number | Y | 5 | - |
...
| Response Body | `CFOAQ00600OutBlock3` | CFOAQ00600OutBlock3 | Object Array | Y | - | - |
...
| Response Body | `-ExecPrc` | 체결가 | Number | Y | 13.2 | - |
