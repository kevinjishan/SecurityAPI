...
api_name: "[업종] 차트"
tr_id: "87477b5n-06j7-j553-67gb-2u6ix76fy6fx"
tr_code: "t8417"
method: "POST"
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Request Body | `t8417InBlock` | t8417InBlock | Object | Y | - | - |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Response Body | `t8417OutBlock` | t8417OutBlock | Object | Y | - | - |
...
| Response Body | `t8417OutBlock1` | t8417OutBlock1 | Object Array | Y | - | - |
