...
tr_id: "59db98ea-003b-4ab6-916d-28c5beaf0f1f"
tr_code: "AS0"
method: "POST"
...
| Response Body | `sPwd` | 비밀번호 | String | Y | 8 | - |
...
| Response Body | `sOrdTime` | 주문시각 | String | Y | 9 | - |
...
| Response Body | `sNmcpySndNo` | 비회원사송신번호 | String | Y | 10 | - |
...
| Response Body | `sOrdUserId` | 주문사원번호 | String | Y | 16 | - |
| Response Body | `sSpotOrdQty` | 실물주문수량 | String | Y | 16 | - |
| Response Body | `sRuseOrdQty` | 재사용주문수량 | String | Y | 16 | - |
| Response Body | `sOrdMny` | 주문현금 | String | Y | 16 | - |
| Response Body | `sOrdSubstAmt` | 주문대용금액 | String | Y | 16 | - |
| Response Body | `sOrdRuseAmt` | 주문재사용금액 | String | Y | 16 | - |
| Response Body | `sUseCmsnAmt` | 사용수수료 | String | Y | 16 | - |
