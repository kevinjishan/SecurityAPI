...
api_name: "[주식] 기타"
tr_id: "1p7tu38d-jj3j-b2ic-s4sm-r3c08o27z7ij"
tr_code: "t1403"
method: "POST"
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Request Body | `t1403InBlock` | t1403InBlock | Object | Y | - | - |
| Request Body | `-gubun` | 구분 | String | Y | 1 | 0: 전체, 1:코스피, 2:코스닥 |
| Request Body | `-styymm` | 시작상장월 | String | Y | 6 | YYYYMM |
| Request Body | `-enyymm` | 종료상장월 | String | Y | 6 | YYYYMM |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Response Body | `t1403OutBlock` | t1403OutBlock | Object | Y | - | - |
| Response Body | `-idx` | IDX | Number | Y | 4 | - |
| Response Body | `t1403OutBlock1` | t1403OutBlock1 | Object Array | Y | - | - |
...
| Response Body | `-kmprice` | 공모가 | Number | Y | 8 | - |
| Response Body | `-date` | 등록일 | String | Y | 8 | - |
| Response Body | `-recprice` | 등록일기준가 | Number | Y | 8 | - |
| Response Body | `-kmdiff` | 기준가등락율 | Number | Y | 6.2 | - |
| Response Body | `-close` | 등록일종가 | Number | Y | 8 | - |
| Response Body | `-recdiff` | 등록일등락율 | Number | Y | 6.2 | - |
