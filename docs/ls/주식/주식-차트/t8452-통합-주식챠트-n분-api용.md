...
api_name: "[주식] 차트"
tr_id: "6cc4c361-966c-41ec-b47b-db02023ef904"
tr_code: "t8452"
method: "POST"
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Request Body | `t8452InBlock` | t8452InBlock | Object | Y | - | - |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Response Body | `t8452OutBlock` | t8452OutBlock | Object | Y | - | - |
...
| Response Body | `-jiclosev` | 전일종가 | Number | Y | 8 | - |
...
| Response Body | `-cts_date` | 연속일자 | Number | Y | 8 | - |
...
| Response Body | `t8452OutBlock1` | t8452OutBlock1 | Object Array | Y | - | - |
...
| Response Body | `-sign` | 종가등락구분(1:상한2:상승3:보합4:하한5:하락) | String | Y | 1 | 1:상한2:상승3:보합4:하한5:하락 |
