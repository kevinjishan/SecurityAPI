...
api_name: "[주식] ELW"
tr_id: "1t66384h-u63g-27d8-6n54-e03j6wb345qz"
tr_code: "t1974"
method: "POST"
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Request Body | `t1974InBlock` | t1974InBlock | Object | Y | - | - |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Response Body | `t1974OutBlock` | t1974OutBlock | Object | Y | - | - |
| Response Body | `-cnt` | 종목갯수 | Number | Y | 4 | - |
| Response Body | `t1974OutBlock1` | t1974OutBlock1 | Object Array | Y | - | - |
