...
api_name: "[주식] ELW"
tr_id: "54gtzn1x-4760-ge6t-c82h-2o010o63p7kj"
tr_code: "t1951"
method: "POST"
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Request Body | `t1951InBlock` | t1951InBlock | Object | Y | - | - |
| Request Body | `-shcode` | 단축코드 | String | Y | 6 | - |
| Request Body | `-cvolume` | 특이거래량 | Number | Y | 12 | 체결량 > 특이체결량인 종목 |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Response Body | `t1951OutBlock` | t1951OutBlock | Object | Y | - | - |
| Response Body | `-cts_time` | 시간CTS | String | Y | 8 | - |
| Response Body | `t1951OutBlock1` | t1951OutBlock1 | Object Array | Y | - | - |
