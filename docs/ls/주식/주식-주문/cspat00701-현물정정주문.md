...
api_name: "[주식] 주문"
tr_id: "87dcqk1e-vbfr-7tlg-o8y2-ndm3v17606m8"
tr_code: "CSPAT00701"
method: "POST"
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Request Body | `CSPAT00701InBlock1` | CSPAT00701InBlock1 | Object | Y | - | - |
...
| Request Body | `-OrdprcPtnCode` | 호가유형코드 | String | Y | 2 | 00@지정가               <br>03@시장가               <br>05@조건부지정가         <br>06@최유리지정가         <br>07@최우선지정가         <br>61@장개시전시간외종가  <br>81@시간외종가          <br>82@시간외단일가 |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Response Body | `CSPAT00701OutBlock1` | CSPAT00701OutBlock1 | Object | Y | - | - |
...
| Response Body | `-OrdprcPtnCode` | 호가유형코드 | String | Y | 2 | 00@지정가               <br>03@시장가               <br>05@조건부지정가         <br>06@최유리지정가         <br>07@최우선지정가        <br>12@중간가 <br>61@장개시전시간외종가  <br>81@시간외종가          <br>82@시간외단일가 |
...
| Response Body | `CSPAT00701OutBlock2` | CSPAT00701OutBlock2 | Object | Y | - | - |
| Response Body | `-RecCnt` | 레코드갯수 | Number | Y | 5 | - |
