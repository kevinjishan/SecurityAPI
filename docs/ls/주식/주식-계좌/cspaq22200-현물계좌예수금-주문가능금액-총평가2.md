...
api_name: "[주식] 계좌"
tr_id: "7lr716yl-mg6i-8211-83o5-u0v38276y0d2"
tr_code: "CSPAQ22200"
method: "POST"
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Request Body | `CSPAQ22200InBlock1` | CSPAQ22200InBlock1 | Object | Y | null | - |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Response Body | `CSPAQ22200OutBlock1` | CSPAQ22200OutBlock1 | Object | Y | null | - |
| Response Body | `-RecCnt` | 레코드갯수 | Number | Y | 5 | 1 |
| Response Body | `-MgmtBrnNo` | 관리지점번호 | String | Y | 3 | 현재 미사용 |
| Response Body | `-BalCreTp` | 잔고생성구분 | String | Y | 1 | 0:주식잔고<br>1:기타 <br>2:재투자잔고<br>3:유통대주<br>4:자기융자<br>5:유통대주<br>6:자기대주 |
| Response Body | `CSPAQ22200OutBlock2` | CSPAQ22200OutBlock2 | Object | Y | null | - |
