...
api_name: "[주식] 상위종목"
tr_id: "o3w1066s-tp5i-2i58-652d-w1qvd0rm230w"
tr_code: "t1482"
method: "POST"
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Request Body | `t1482InBlock` | t1482InBlock | Object | Y | - | - |
| Request Body | `-sort_gbn` | 정렬구분 | Number | Y | 1 | 0: 거래량<br>1: 거래대금 |
| Request Body | `-gubun` | 구분 | String | Y | 1 | 0: 전체<br>1: 코스피<br>2: 코스닥 |
| Request Body | `-jongchk` | 거래량 | String | Y | 1 | 0: 전체<br>1: 우선제외<br>2: 관리제외<br>3: 우선관리제외 |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Response Body | `t1482OutBlock` | t1482OutBlock | Object | Y | - | - |
| Response Body | `-idx` | IDX | Number | Y | 4 | - |
| Response Body | `t1482OutBlock1` | t1482OutBlock1 | Object Array | Y | - | - |
