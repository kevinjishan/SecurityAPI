...
api_name: "[주식] 실시간 시세"
tr_id: "9399267d-089d-4e49-9553-a65bcdba8bb5"
tr_code: "NBT"
method: "POST"
...
| Request Body | `tr_key` | 단축코드 | String | N | 4 | N + 업종코드 |
...
| Response Body | `tjjcode2` | 투자자코드2(외국인) | String | Y | - | - |
...
| Response Body | `msval3` | 거래대금순매수3 | Number | Y | 6 | - |
...
| Response Body | `tjjcode9` | 투자자코드9(기금) | Number | Y | 4 | - |
...
| Response Body | `msvalue10` | 매수거래대금10 | Number | Y | 8 | - |
...
| Response Body | `msvolume0` | 매수거래량0 | Number | Y | 8 | - |
