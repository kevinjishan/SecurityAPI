...
api_name: "[주식] 실시간 시세"
tr_id: "86oo7q0s-td45-oxnn-y8x4-73z7f6g21g58"
tr_code: "VI_"
method: "POST"
...
| Request Body | `tr_key` | 단축코드 | String | N | 6 | 단축코드 6자리 |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Response Body | `vi_gubun` | 구분(0:해제1:정적발동2:동적발동3:정적&동적) | String | Y | 1 | - |
| Response Body | `svi_recprice` | 정적VI발동기준가격 | String | Y | 8 | - |
| Response Body | `dvi_recprice` | 동적VI발동기준가격 | String | Y | 8 | - |
| Response Body | `vi_trgprice` | VI발동가격 | String | Y | 8 | - |
| Response Body | `shcode` | 단축코드(KEY) | String | Y | 6 | - |
| Response Body | `ref_shcode` | 참조코드 | String | Y | 6 | - |
