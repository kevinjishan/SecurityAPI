...
api_name: "[주식] 실시간 시세"
tr_id: "kv031av8-4am0-f4sy-x32p-r842g57t7tkh"
tr_code: "I5_"
method: "POST"
...
| Response Body | `navdiff` | NAV대비 | String | Y | 9.2 | - |
| Response Body | `nav` | NAV | String | Y | 9.2 | - |
| Response Body | `navchange` | 전일대비 | String | Y | 9.2 | - |
| Response Body | `crate` | 추적오차 | String | Y | 9.2 | - |
| Response Body | `grate` | 괴리 | String | Y | 9.2 | - |
| Response Body | `jisu` | 지수 | String | Y | 8.2 | - |
| Response Body | `jichange` | 전일대비 | String | Y | 8.2 | - |
| Response Body | `jirate` | 전일대비율 | String | Y | 8.2 | - |
