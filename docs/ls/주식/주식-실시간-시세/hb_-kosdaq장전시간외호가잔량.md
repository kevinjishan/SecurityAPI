...
api_name: "[주식] 실시간 시세"
tr_id: "wle47rf0-oqr3-446b-7766-z2nd36054b6u"
tr_code: "HB_"
method: "POST"
...
| Response Body | `tmofferrem` | 시간외매도잔량 | String | Y | 12 | - |
| Response Body | `tmbidrem` | 시간외매수잔량 | String | Y | 12 | - |
| Response Body | `pretmoffercha` | 시간외매도수량직전대비 | String | Y | 12 | - |
| Response Body | `pretmbidcha` | 시간외매수수량직전대비 | String | Y | 12 | - |
