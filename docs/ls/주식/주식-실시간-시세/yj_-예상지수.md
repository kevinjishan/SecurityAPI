...
api_name: "[주식] 실시간 시세"
tr_id: "212vj75s-c7xe-4b16-jqgk-u6556883o8ev"
tr_code: "YJ_"
method: "POST"
...
| Response Body | `jisu` | 예상지수 | String | Y | 8.2 | - |
| Response Body | `sign` | 예상전일대비구분 | String | Y | 1 | - |
| Response Body | `change` | 예상전일비 | String | Y | 8.2 | - |
| Response Body | `drate` | 예상등락율 | String | Y | 6.2 | - |
| Response Body | `cvolume` | 예상체결량 | String | Y | 8 | - |
| Response Body | `volume` | 누적거래량 | String | Y | 8 | - |
| Response Body | `value` | 예상거래대금 | String | Y | 8 | - |
