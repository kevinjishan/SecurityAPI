...
api_name: "[주식] 실시간 시세"
tr_id: "dgb3zvti-2k01-jhfa-6c63-7pmb27qqtw67"
tr_code: "DVI"
method: "POST"
...
| Request Body | `tr_key` | 단축코드 | String | N | 6 | 단축코드 6자리 또는 전체종목 '000000' |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Response Body | `vi_gubun` | 구분(0:해제 1:정적발동 2:동적발동 3:정적&동적) | String | Y | 1 | - |
