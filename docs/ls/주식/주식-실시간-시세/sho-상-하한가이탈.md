...
api_name: "[주식] 실시간 시세"
tr_id: "0s54ip50-226q-252z-e2in-3moti270h24t"
tr_code: "SHO"
method: "POST"
...
| Response Body | `updnlmtprice` | 상/하한가 | String | Y | 8 | - |
| Response Body | `updnlmtchange` | 상/하한가대비 | String | Y | 8 | - |
| Response Body | `updnlmtdrate` | 상/하한가대비율 | String | Y | 6.2 | - |
