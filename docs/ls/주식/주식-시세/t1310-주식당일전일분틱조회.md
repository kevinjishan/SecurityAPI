...
api_name: "[주식] 시세"
tr_id: "m5385w1v-6qqk-4mp7-v4u2-47574734x8g2"
tr_code: "t1310"
method: "POST"
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Request Body | `t1310InBlock` | t1310InBlock | Object | Y | - | - |
| Request Body | `-daygb` | 당일전일구분 | String | Y | 1 | 0:당일<br>1:전일 |
| Request Body | `-timegb` | 분틱구분 | String | Y | 1 | 0:분<br>1:틱 |
| Request Body | `-shcode` | 단축코드 | String | Y | 6 | - |
| Request Body | `-endtime` | 종료시간 | String | Y | 4 | 처음 조회시 시간 입력값.<br>t1310OutBlock1.chetime <= endtime 인 데이터 조회됨. |
| Request Body | `-cts_time` | 시간CTS | String | Y | 10 | 처음 조회시 Space<br>다음 조회시 t1310OutBlock.cts_time 값 입력 |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Response Body | `t1310OutBlock` | t1310OutBlock | Object | Y | - | - |
| Response Body | `-cts_time` | 시간CTS | String | Y | 10 | - |
| Response Body | `t1310OutBlock1` | t1310OutBlock1 | Object Array | Y | - | - |
