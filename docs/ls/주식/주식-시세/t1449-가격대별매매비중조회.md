...
api_name: "[주식] 시세"
tr_id: "12qs34im-4k4k-vg4k-66rb-y402u56md2gn"
tr_code: "t1449"
method: "POST"
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Request Body | `t1449InBlock` | t1449InBlock | Object | Y | - | - |
| Request Body | `-shcode` | 단축코드 | String | Y | 6 | - |
| Request Body | `-dategb` | 일자구분 | String | Y | 1 | 1@당일<br>2@전일<br>3@당일+전일 |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Response Body | `t1449OutBlock` | t1449OutBlock | Object | Y | - | - |
...
| Response Body | `-msvolume` | 매수체결량 | Number | Y | 12 | - |
| Response Body | `-mdvolume` | 매도체결량 | Number | Y | 12 | - |
| Response Body | `t1449OutBlock1` | t1449OutBlock1 | Object Array | Y | - | - |
| Response Body | `-price` | 체결가 | Number | Y | 8 | - |
| Response Body | `-sign` | 전일대비구분 | String | Y | 1 | - |
| Response Body | `-change` | 전일대비 | Number | Y | 8 | - |
| Response Body | `-tickdiff` | 등락율 | Number | Y | 6.2 | - |
| Response Body | `-cvolume` | 체결수량 | Number | Y | 12 | - |
| Response Body | `-diff` | 비중 | Number | Y | 6.2 | - |
| Response Body | `-mdvolume` | 매도체결량 | Number | Y | 12 | - |
| Response Body | `-msvolume` | 매수체결량 | Number | Y | 12 | - |
| Response Body | `-msdiff` | 매수비율 | Number | Y | 6.2 | - |
