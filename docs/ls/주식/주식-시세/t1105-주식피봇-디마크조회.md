...
api_name: "[주식] 시세"
tr_id: "c4w2ylo3-34d0-10an-p0ul-41nv25j20s16"
tr_code: "t1105"
method: "POST"
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Request Body | `t1105InBlock` | t1105InBlock | Object | Y | - | - |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Response Body | `t1105OutBlock` | t1105OutBlock | Object | Y | - | - |
| Response Body | `-shcode` | 단축코드 | String | Y | 6 | - |
| Response Body | `-pbot` | 피봇 | Number | Y | 8 | - |
| Response Body | `-offer1` | 1차저항 | Number | Y | 8 | - |
| Response Body | `-supp1` | 1차지지 | Number | Y | 8 | - |
| Response Body | `-offer2` | 2차저항 | Number | Y | 8 | - |
| Response Body | `-supp2` | 2차지지 | Number | Y | 8 | - |
| Response Body | `-stdprc` | 기준가격 | Number | Y | 8 | - |
| Response Body | `-offerd` | D저항 | Number | Y | 8 | - |
| Response Body | `-suppd` | D지지 | Number | Y | 8 | - |
