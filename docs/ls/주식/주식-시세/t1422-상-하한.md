...
api_name: "[주식] 시세"
tr_id: "ifbnu5gu-g826-qa0s-tyl8-68854p8y34wb"
tr_code: "t1422"
method: "POST"
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Request Body | `t1422InBlock` | t1422InBlock | Object | Y | - | - |
| Request Body | `-qrygb` | 조회구분 | String | Y | 1 | 1:20종목씩 조회<br>2:전체조회 |
| Request Body | `-gubun` | 구분 | String | Y | 1 | 0:전체<br>1:코스피<br>2:코스닥 |
| Request Body | `-jnilgubun` | 전일구분 | String | Y | 1 | 0:당일<br>1:전일 |
| Request Body | `-sign` | 상하한구분 | String | Y | 1 | 1:상한<br>4:하한 |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Response Body | `t1422OutBlock` | t1422OutBlock | Object | Y | - | - |
| Response Body | `-cnt` | CNT | Number | Y | 4 | - |
| Response Body | `-idx` | IDX | Number | Y | 4 | - |
| Response Body | `t1422OutBlock1` | t1422OutBlock1 | Object Array | Y | - | - |
...
| Response Body | `-last` | 최종진입 | String | Y | 6 | - |
