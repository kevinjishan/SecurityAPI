...
api_name: "[주식] 시세"
tr_id: "80fs5s20-0zdv-pwy6-fuvc-i145b873aw1a"
tr_code: "t1308"
method: "POST"
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Request Body | `t1308InBlock` | t1308InBlock | Object | Y | - | - |
| Request Body | `-shcode` | 단축코드 | String | Y | 6 | - |
| Request Body | `-starttime` | 시작시간 | String | Y | 4 | 장시작시간 이후(hhmm) |
| Request Body | `-endtime` | 종료시간 | String | Y | 4 | 장종료시간 이전(hhmm) |
| Request Body | `-bun_term` | 분간격 | String | Y | 2 | - |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Response Body | `t1308OutBlock` | t1308OutBlock | Object | Y | - | - |
| Response Body | `-ex_shcode` | 거래소별단축코드 | String | Y | 10 | - |
| Response Body | `t1308OutBlock1` | t1308OutBlock1 | Object Array | Y | - | - |
