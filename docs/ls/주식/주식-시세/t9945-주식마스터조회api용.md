...
api_name: "[주식] 시세"
tr_id: "u4hepin5-rfe4-3g3p-8yn3-7xko30x5hm5z"
tr_code: "t9945"
method: "POST"
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Request Body | `t9945InBlock` | t9945InBlock | Object | Y | - | - |
| Request Body | `-gubun` | 구분(KSP:1KSD:2) | String | Y | 1 | - |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Response Body | `t9945OutBlock` | t9945OutBlock | Object Array | Y | - | - |
| Response Body | `-hname` | 종목명 | String | Y | 40 | - |
| Response Body | `-shcode` | 단축코드 | String | Y | 6 | - |
| Response Body | `-expcode` | 확장코드 | String | Y | 12 | - |
| Response Body | `-etfchk` | ETF구분 | String | Y | 1 | - |
| Response Body | `-nxt_chk` | NXT상장구분 | String | Y | 1 | 1:NXT 거래소 제공<br>0:NXT 거래소 미제공 |
| Response Body | `-filler` | filler | String | Y | 4 | - |
