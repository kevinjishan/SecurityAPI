...
api_name: "[주식] 시세"
tr_id: "eoh24044-jl6s-v36m-6157-0x6d81okpr3x"
tr_code: "t1486"
method: "POST"
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Request Body | `t1486InBlock` | t1486InBlock | Object | Y | - | - |
...
| Request Body | `-cnt` | 조회건수 | Object | Y | 4 | 0020 |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Response Body | `t1486OutBlock` | t1486OutBlock | Object | Y | - | - |
| Response Body | `-cts_time` | 시간CTS | String | Y | 10 | - |
| Response Body | `-ex_shcode` | 거래소별단축코드 | String | Y | 10 | - |
| Response Body | `t1486OutBlock1` | t1486OutBlock1 | Object Array | Y | - | - |
...
| Response Body | `-cvolume` | 예상체결량 | Number | Y | 12 | - |
| Response Body | `-offerho1` | 매도호가 | Number | Y | 8 | - |
| Response Body | `-bidho1` | 매수호가 | Number | Y | 8 | - |
