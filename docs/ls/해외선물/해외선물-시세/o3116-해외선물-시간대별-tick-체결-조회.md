...
api_name: "[해외선물] 시세"
tr_id: "avf4s57l-c4ga-680i-0uq1-66g34d8udc5c"
tr_code: "o3116"
method: "POST"
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Request Body | `o3116InBlock` | o3116InBlock | Object | Y | - | - |
| Request Body | `-gubun` | 조회구분 | String | Y | 1 | 0:당일 만 사용가능 |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Response Body | `o3116OutBlock` | o3116OutBlock | Object | Y | - | - |
| Response Body | `-cts_seq` | 순번CTS | Number | Y | 8 | - |
| Response Body | `o3116OutBlock1<br>(Occurs)` | o3116OutBlock1<br>(Occurs) | Object Array | Y | - | - |
