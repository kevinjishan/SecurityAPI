...
api_name: "[해외선물] 시세"
tr_id: "62nwofv5-b6dd-ak84-y10q-swp5b88easv3"
tr_code: "o3107"
method: "POST"
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Request Body | `o3107InBlock<br>(Occurs)` | o3107InBlock<br>(Occurs) | Object Array | Y | - | - |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Response Body | `o3107OutBlock<br>(Occurs)` | o3107OutBlock<br>(Occurs) | Object Array | Y | - | - |
