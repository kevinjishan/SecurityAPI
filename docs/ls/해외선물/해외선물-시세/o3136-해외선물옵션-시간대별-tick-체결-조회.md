...
api_name: "[해외선물] 시세"
tr_id: "k4kemoq4-4w87-u42c-j7zm-oj5qq8d7027o"
tr_code: "o3136"
method: "POST"
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Request Body | `o3136InBlock` | o3136InBlock | Object | Y | - | - |
| Request Body | `-gubun` | 조회구분 | String | Y | 1 | ex) 0(당일), 1(전일) |
...
| Request Body | `-cts_seq` | 순번CTS | Number | Y | 8 | - |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Response Body | `o3136OutBlock` | o3136OutBlock | Object | Y | - | - |
| Response Body | `-cts_seq` | 순번CTS | Number | Y | 8 | - |
| Response Body | `o3136OutBlock1<br>(Occurs)` | o3136OutBlock1<br>(Occurs) | Object Array | Y | - | - |
| Response Body | `-ovsdate` | 현지일자 | String | Y | 8 | - |
| Response Body | `-ovstime` | 현지시간 | String | Y | 6 | - |
...
| Response Body | `-cvolume` | 체결수량 | Number | Y | 10 | - |
