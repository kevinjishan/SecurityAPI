...
api_name: "[해외선물] 시세"
tr_id: "r1ot4gi1-gt0u-bonc-ru51-e58gp6wner6d"
tr_code: "o3104"
method: "POST"
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Request Body | `o3104InBlock` | o3104InBlock | Object | Y | - | - |
| Request Body | `-gubun` | 조회구분 | String | Y | 1 | 0:일별<br>1:주별<br>2:월별 |
| Request Body | `-shcode` | 단축코드 | String | Y | 8 | - |
| Request Body | `-date` | 조회일자 | String | Y | 8 | YYYYMMDD |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Response Body | `o3104OutBlock1<br>(Occurs)` | o3104OutBlock1<br>(Occurs) | Object Array | Y | - | - |
| Response Body | `-chedate` | 일자 | String | Y | 8 | - |
| Response Body | `-price` | 현재가 | Number | Y | 15.9 | - |
| Response Body | `-sign` | 대비구분 | String | Y | 1 | - |
| Response Body | `-change` | 대비 | Number | Y | 15.9 | - |
