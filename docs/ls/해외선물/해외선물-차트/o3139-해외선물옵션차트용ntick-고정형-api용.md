...
api_name: "[해외선물] 차트"
tr_id: "c1hb04fe-hq4i-030c-210r-0e8pr14z3x71"
tr_code: "o3139"
method: "POST"
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Request Body | `o3139InBlock` | o3139InBlock | Object | Y | - | - |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Response Body | `o3139OutBlock` | o3139OutBlock | Object | Y | - | - |
...
| Response Body | `-last_count` | 마지막Tick건수 | Number | Y | 4 | - |
| Response Body | `o3139OutBlock1<br>(Occurs)` | o3139OutBlock1<br>(Occurs) | Object Array | Y | - | - |
