...
api_name: "[해외선물] 차트"
tr_id: "6ds88k84-z7x1-5t7b-0aj8-13ormd5084iu"
tr_code: "o3103"
method: "POST"
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Request Body | `o3103InBlock` | o3103InBlock | Object | Y | - | - |
| Request Body | `-shcode` | 단축코드 | String | Y | 8 | ex) ADU13 |
...
| 위치 | 필드 | 이름 | 타입 | 필수 | 길이 | 설명 |
| --- | --- | --- | --- | --- | --- | --- |
| Response Body | `o3103OutBlock` | o3103OutBlock | Object | Y | - | - |
...
| Response Body | `o3103OutBlock1<br>(Occurs)` | o3103OutBlock1<br>(Occurs) | Object Array | Y | - | - |
