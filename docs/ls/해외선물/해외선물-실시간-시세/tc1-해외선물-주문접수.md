...
tr_id: "o5f0eane-37wy-jve6-t12s-sb6f200f5vh0"
tr_code: "TC1"
method: "POST"
...
| Response Body | `svc_id` | 서비스ID | String | Y | 4 | HO01:주문ACK<br>HO04:주문Pending |
...
| Response Body | `xrc_rsv_tp_code` | 행사예약구분코드 | String | Y | 1 | 1: 옵션행사예약<br>0: 옵션행사예약아님 |
